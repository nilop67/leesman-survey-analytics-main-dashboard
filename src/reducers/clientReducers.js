...
export const campaignDetailsReducer = (state = {
    loading: false,
    data: [],
    error: null
}, action) => {
...
export const campaignsGraf = (state = {
    isLoading: false,
    graphs: [],
    error: null
}, action) => {
...
export const bufferCampaignsReducer = (state = {
    isLoading: false,
    bufferCampaigns: [],
    error: null
}, action) => {
...
export const feedbackCommentsViewReducer = (state = {
    isLoading: false,
    userFeedback: [],
    error: null
}, action) => {
...
export const feedbackJoinDataViewReducer = (state = {
    isLoading: false,
    joinData: [],
    error: null
}, action) => {
...
export const feedbackClientDataViewReducer = (state = {
    isLoading: false,
    clientData: [],
    error: null
}, action) => {
...
export const feedBackResult = (state = {
    isLoading: false,
    isScoreData: "",
...
export const feedBackThemeView = (state = {
    isLoading: false,
    scales: [],
    error: null
}, action) => {
...
export const regionsGlobal = (state = {
    data: [],
    isLoading: false,
    error: false
}, action) => {
...
export const campaignClosedDetails = (state = {
    isLoading: false,
    data: [],
    commentData: [],
    stats: [],
...
export const waveEngagement = (state = {
    isLoading: false,
    activeUsersData: [],
    stats: [],
    locationBreakdownData: [],
...
export const newSurveyHomeReducer = (state = {
    allCountries: 0,
    countryByClientId: 0,
    allWorkplaces: 0,
