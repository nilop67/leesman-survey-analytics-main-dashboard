...
const Clients = () => {
  ...
  const [show, setShow] = useState(localStorage.getItem("showClients") ? JSON.parse(localStorage.getItem("showClients")) : true);
  ...
  useEffect(() => {
    customfilter(
      val,
      clients,
      ["key", "name", "refNo", "website", "industry", "userCount", "weeklyXp", "locationCount"],
      setBuffer
    );
  }, [val]);
          ...
          <div className="col-xl-12 col-lg-12 col-md-12">
            <div className="row mb-4 page-__header">
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 jus-end">
                ...
                <ImportExport refresh={getData} type="client" data={buffer} import={false} export={true} />
                ...
                <div className="input-group ml-3">
                  ...
                  {/* yeni arama */}
                  <input type="text" value={val} onChange={change} className="form-control" placeholder="Search" />
                </div>
              </div>
            </div>
          </div>
