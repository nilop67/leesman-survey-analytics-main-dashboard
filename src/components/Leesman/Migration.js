...
const Migration = () => {
  ...
  const {allData, error} = useSelector(store => store.leesmanMigration)
          ...
          <div className="col-md-12 col-sm-12">
            <ul className="nav nav-tabs3 mt-0 mb-2">
              <li className="nav-item">
                <a
                  className={`nav-link ${selectedTab === "Clients" && " active"}`}
              ...
              <li className="nav-item">
                <a
                  className={`nav-link ${selectedTab === "Departments" && " active"}`}
              ...
              <li className="nav-item">
                <a
                  className={`nav-link ${selectedTab === "Locations" && " active"}`}
              ...
              <li className="nav-item">
                <a
                  className={`nav-link ${selectedTab === "Options" && " active"}`}
              ...
              <div className="migrated_card">
                ...
                <div className="row text-center">
                  <div className="col-lg-6 border-right">
                    ...
                    <p className="text-muted mt-0 mb-0">Analiytics Data label 1</p>
                  </div>
              ...
              <div className="migrated_card">
                ...
                <div className="row text-center">
                  <div className="col-lg-6 border-right">
                    ...
                    <p className="text-muted mt-0 mb-0">Analiytics Data label 5</p>
                    <p className="text-muted mt-0 mb-0">Analiytics Data label 6</p>
                  </div>
                  <div className="col-lg-6">
                    <label className="mb-0">
                      <strong>INDSIDE DATA</strong>
              ...
              <div className="migrated_card">
                ...
                <div className="row text-center">
                  <div className="col-lg-6 border-right">
                    ...
                    <p className="text-muted mt-0 mb-0">Analiytics Data label 1</p>
                    <p className="text-muted mt-0 mb-0">Analiytics Data label 2</p>
                  </div>
                  <div className="col-lg-6">
                    <label className="mb-0">
                      <strong>INDSIDE DATA</strong>
