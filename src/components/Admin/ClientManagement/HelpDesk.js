...
const HelpDesk = (props) => {
  ...
  function getData() {
    dispach(getHelpDeskDataAction({clientId}))
     
      .get(`/admin/clients/${clientId}/helpdesk`)
  ...
  return (
    <>
      <div className="container-fluid clients-page helpdesk-page new-2022_class">
        ...
        <div className={`modal fade bd-example-modal-lg ${state.openModal === "new-helpdesk" ? " d-block show" : ""}`}>
          <HelpDeskModal data={modalData} editData={editData} close={closeGroups}></HelpDeskModal>
        </div>
      </div>
    </>
  );
