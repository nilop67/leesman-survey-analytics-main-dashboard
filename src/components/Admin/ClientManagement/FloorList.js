...
import { floorListDeleteLocationAction , getFloorDataAction} from "../../../actions/adminActions";
        ...
        <div className="col-xl-12 col-lg-12 col-md-12">
          <div className="row mb-4 page-__header">
            <div className="col-xl-6 col-lg-6 col-md-6">
              ...
              <span className="text-table-info">Total: {locationData.filter((i) => i.parent_id).length} Floors</span>
            </div>
