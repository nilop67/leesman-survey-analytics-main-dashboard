            ...
            <div className="col-md-12 col-sm-12">
              ...
              <ul className="nav nav-tabs3 mt-4 mb-4">
                <li className="nav-item">
                  <a
                    className={`nav-link ${isSurveyTab === "Translations" && " active"}`}
                ...
                <li className="nav-item">
                  <a
                    className={`nav-link ${isSurveyTab === "Surveys" && " active"}`}
                ...
                <li className="nav-item">
                  <a
                    className={`nav-link ${isSurveyTab === "Sections" && " active"}`}
                ...
                <li className="nav-item">
                  <a
                    className={`nav-link ${isSurveyTab === "Pages" && " active"}`}
                ...
                <li className="nav-item">
                  <a
                    className={`nav-link ${isSurveyTab === "Questions" && " active"}`}
                ...
                <li className="nav-item">
                  <a
                    className={`nav-link ${isSurveyTab === "Dependencies" && " active"}`}
