...
const GeneralSetup = ({ initData, setInitData, surveyId, clientId, formData, setFormData, close, send, reset, previousData }) => {
  ...
  useEffect(() => {
    ...
    setDemo(formData?.general ? !["live", "in build"].includes(formData?.general?.status) : true);
  }, [formData]);
          ...
          <div className="sentiment-wrapper">
            <div className="row clearfix">
              ...
              <div className="col-lg-3 col-md-12">
                <div className="form-group">
                  <label>Agent</label>
                  <select className="form-control" name="agent_id" onChange={change} value={data?.agent_id}>
                ...
                <div className="form-group">
                  ...
                  >
                    ...
                    {initData?.modules
                      ?.filter((i) => i.is_core)
                      ?.map((a) => {
                        return <option value={a.id}>{a.label.capitalize()}</option>;
                      })}
                  </select>
                </div>
              </div>
                      ...
                      <>
                        <Tooltip title="Start date">
                          <DatePicker
                            ...
                            value={data?.start_date ? moment(data?.start_date ? data?.start_date.splitDate() : null) : moment()}
                          />
                        </Tooltip>
                        <Tooltip title="End date">
                          <DatePicker
                            ...
                            format="YYYY-MM-DD"
                            defaultPickerValue={moment()}
                            value={data?.end_date ? moment(data?.end_date ? data?.end_date.splitDate() : null) : moment()}
                          />
                        </Tooltip>
                      </>
                    </div>
              ...
              <div className="col-lg-4 col-md-12 mt-2">
                <p className="mb-1">
                  Respondents will log in to the survey by using their own email address or unique provided codes.
                </p>
                    ...
                    <div className="form-group mt-2 mb-0">
                      <button
                        ...
                        onClick={() => {
                          ...
                          notification.success({ message: "Invite link copied to clipboard!" });
                        }}
                      >
                        Survey link
                      </button>
              ...
              <div className="col-lg-2 col-md-12">
                <div className="form-group">
                  ...
                  >
                    ...
                    {initData?.languages?.sortAlphabetically("label").map((a) => {
              ...
              <div className="col-lg-2 col-md-12">
                <div className="form-group">
                  ...
                  <select className="form-control show-tick" value={data?.location_sort} name="location_sort" onChange={change}>
