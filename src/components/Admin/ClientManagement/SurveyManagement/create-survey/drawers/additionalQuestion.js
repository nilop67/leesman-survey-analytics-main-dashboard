        ...
        <div className="sentiment-wrapper">
          <div className="row clearfix">
                    ...
                    <>
                      <div className="add_fields_row">
                        ...
                        <div className="fields_btn_group">
                          {inputList.length !== 1 && (
                            <button onClick={() => handleRemoveClick(i)} className="btn btn-sm " title="Remove domain">
                              <span className="iconx-minus1"></span>
                            </button>
                          )}

                          {inputList.length - 1 === i && (
                            <button className="btn btn-sm" onClick={handleAddClick} title="Add domain">
                              <span style={{ color: "black" }} className="iconx-plus1"></span>
                            </button>
                          )}
                        </div>
                      </div>
            ...
            <div className="col-lg-12 col-md-12 mt-4 bottoms-_btn-group">
              <button onClick={reset} className="btn btn-sm btn-default mr-1 float-l">
                Cancel
              </button>{" "}
              &nbsp;&nbsp;
              <button onClick={send} className="btn btn-sm btn-primary ml-2 float-l">
                Save
              </button>
            </div>
          </div>
