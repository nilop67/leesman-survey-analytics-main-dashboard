...
const Dependencies = () => {
  ...
  const [isValueType, setValueType] = useState("");
  const [isValueMultiType, setValueMultiType] = useState("");

  const [isConditionType, setConditionType] = useState("");

  const [isTargetSelection, setTargetSelection] = useState("");
  const [isTargetType, setTargetType] = useState("");
              ...
              <div className="body">
                <div className="row clearfix">
                  ...
                  <div className="col-lg-12 col-md-12 mt-3">
                    ...
                    <label className="fancy-radio">
                      <input type="radio" name="type" value="page" id="page" onChange={(e) => setValueType(e.target.value)} />
                      <span className="light-black">
                        <i></i>
                        Page
                      </span>
                  ...
                  <div className="col-lg-12 col-md-12 mt-3">
                    ...
                    <button onClick={() => setIsChildrenModalVisible(true)} className="btn btn-outline-default btn-sm mt-0">
                      Select value(s)
                    </button>
                ...
                <div className="row clearfix">
                  <div className="col-lg-6 col-md-6 mt-3">
                    ...
                    <div className="form-group">
                      <select className="form-control" onChange={(e) => setConditionType(e.target.value)}>
                    ...
                    {isConditionType === "Greater" || isConditionType === "Lower" ? (
                      <div className="form-group">
                        <input type="number" className="form-control" placeholder="Type value." name="value" />
                      </div>
                    ) : (
                      <></>
                    )}
          ...
          <div className="row clearfix">
            <div className="col-md-12 col-sm-12">
              ...
              <div className="questions--list-s">
                ...
                <div className="text-leftt light-black pb-20 pt--40">Formal Meetings</div>
        ...
        <div className="col-xl-12 col-lg-12 col-md-12">
          <div className="row mb-4 page-__header">
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 jus-end">
              <a className="btn btn-primary bigger-_btn ml-3" href="#!" onClick={() => setIsModalVisible(true)}>
                New dependency
              </a>
                ...
                <article className="media body mb-0">
                  <div className="media-body">
                      ...
                      <div className="d-flex justify-content-start mb-3">
                        <div className="mr-5">
                          ...
                          <small className="text-muted">
                            <strong>Items:</strong> Section 1, Section 2, Section 3
                          </small>
                        </div>
                        <div className="mr-5">
                          <label className="mb-0">
                          ...
                          <small className="text-muted">Greater than - 50</small>
                          <br />
                          <small className="text-muted">(Order) Before that(s)</small>
                        </div>
                        <div>
                          <label className="mb-0">
                    ...
                    <nav className="d-flex text-muted">
                      <a href="#!" onClick={() => setIsModalVisible(true)} className="icon mr-3">
                      ...
                      <span className="text-danger ml-auto mr--10">Private</span>
                    </nav>
                  </div>
                </article>
              </div>
                ...
                <article className="media body mb-0">
                  <div className="media-body">
                    <div className="content">
                      ...
                      <div className="d-flex justify-content-start mb-3">
                        ...
                        <div className="mr-5">
                          ...
                          <br />
                          <small className="text-muted">(Hide) Hide that(s)</small>
                        </div>
                        <div>
                          <label className="mb-0">
                            <strong>Target</strong>
                    ...
                    <nav className="d-flex text-muted">
                      ...
                      <span className="text-success ml-auto mr--10">Public</span>
                    </nav>
                  </div>
                </article>
              </div>
