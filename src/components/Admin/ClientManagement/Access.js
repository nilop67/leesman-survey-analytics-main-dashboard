      ...
      <div className="container-fluid survey-page">
        ...
        <div className="row clearfix">
          ...
          <div className="col-xl-6 col-lg-6 col-md-6">
            <div className="card">
              <div className="body min-h-381">
                <h2 className="card-title mb-0">Access to the survey - Email domains</h2>
          ...
          <div className="col-xl-6 col-lg-6 col-md-6">
            <div className="card">
              <div className="body min-h-381">
                <h2 className="card-title mb-0">Access to the survey - IP Whitelist</h2>
                <div className="row clearfix pt-20 pb-34">
                  <div className="col-lg-12 col-md-12">
                    <AddIp />
                  </div>
          ...
          <div className="col-xl-6 col-lg-6 col-md-6">
            <div className="card">
              <div className="body min-h-381">
                <h2 className="card-title mb-0">Notifications when the survey is live</h2>
                <div className="row clearfix pt-20 pb-34">
                  <div className="col-lg-12 col-md-12">
                    <AddNotification />
                  </div>
