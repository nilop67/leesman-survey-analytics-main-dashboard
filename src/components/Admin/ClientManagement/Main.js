            ...
            <div className="card">
              <div className="body">
                <div className="row clearfix">
                  ...
                  <div className="col-lg-6 col-md-12">
                    <div className="form-group">
                      <select value={formData.industry} className="form-control" onChange={handleChange}>
                  ...
                  <div className="col-lg-6 col-md-6">
                    <Space>
                      <span className="light-black">Question validity period (days):</span>
                      <input
                        type="number"
                        className="form-control"
                  ...
                  <div className="col-lg-6 col-md-6">
                    <label className="fancy-checkbox min-w-168">
                      <input
                        onChange={() => {
                          setFormData((pre) => {
                            return { ...pre, enable_inside: !formData.enable_inside };
                          });
                        }}
                      ...
                      <>
                        <label className="fancy-checkbox min-w-168">
                          <input
                            ...
                            onChange={() => {
                              setFormData((pre) => {
                                return { ...pre, enable_feedbacks: !formData.enable_feedbacks };
                              });
                            }}
                            type="checkbox"
                          />
                        ...
                        <label className="fancy-checkbox min-w-168">
                          <input
                            ...
                            onChange={() => {
                              setFormData((pre) => {
                                return { ...pre, enable_questions: !formData.enable_questions };
                              });
                            }}
                            type="checkbox"
                          />
                        ...
                        <label className="fancy-checkbox min-w-168">
                          <input
                            onChange={() => {
                              setFormData((pre) => {
                                return { ...pre, enable_xp: !formData.enable_xp };
                              });
                            }}
                    ...
                    <div className="col-lg-6 col-md-6">
                      <div className="form-group mt-2 mb-0">
                        <button
                          ...
                          onClick={() => {
                            navigator.clipboard.writeText(window.location.origin + "/signup?invite_code=" + formData.invite_code);
                  ...
                  <div className="col-lg-12 col-md-12 mt-5">
                    ...
                    &nbsp;&nbsp;
                    <button onClick={NewClient} className="btn btn-sm btn-primary mr-1 float-r">
                      Save
                    </button>
                  </div>
                </div>
