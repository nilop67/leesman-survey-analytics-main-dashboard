...
import { notification, Input, Table, Divider, Modal, Tooltip, Button } from "antd";
...
function DomainVerify(props) {
  ...
  const confirmDelete = () => {
    setVisible(false);
    API.del("CoreAPI", `/admin/clients/${clientId}/domains/${formData.deleteId}`)
      .then((res) => {
  ...
  const columns = [
    ...
    },
    {
      title: "Verified",
      dataIndex: "verified",
      render: (verified) => (verified ? <CheckOutlined /> : <ClockCircleOutlined />),
    },
    {
      title: "Token",
      dataIndex: "token",
    },
    {
      ...
      render: (domain) => (
        ...
        <Tooltip title="Delete">
          <button onClick={() => promptDelete(domain.id)} className="btn btn-sm btn-liste cursorp">
  ...
  return (
    <>
      ...
      >
        <p className="light-black">{`Are you sure you want to remove ${domains.find((x) => x.id === formData.deleteId)?.name}?`}</p>
      </Modal>
      ...
      <div className="container-fluid clients-page new-2022_class">
        ...
        <div className="row clearfix">
          <div className="col-xl-12 col-lg-12 col-md-12">
            <div className="row mb-4 page-__header">
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 jus-end">
                <button onClick={refresh} title="Refresh" className="btn btn-primary icon-_btn">
          ...
          <div className="col-xl-12 col-lg-12 col-md-12">
            <div className="card">
                <Table columns={columns} rowKey={(x) => x.id} loading={tableLoading} dataSource={domains} />
          ...
          <div className="col-xl-12 col-lg-12 col-md-12">
            <div className="card without-btn-table">
                <p className="mt-3 mb-0">Please add the token in a TXT record to your domain under the name _leesman</p>
                <p>For example:</p>
                <Table
                  columns={[
                    {
