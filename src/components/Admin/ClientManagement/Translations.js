                ...
                <div className="row clearfix pt-20 pb-34">
                  <div className="col-lg-12 col-md-12">
                    <button
                      ...
                      className={`btn btn-sm btn-default mr-1 float-l ${transCategory === "locations" ? "active" : ""}`}
                    >
                      Locations
                    </button>{" "}
                    &nbsp;&nbsp;
                    <button onClick={() => setTransCategory("departments")} className="btn btn-sm btn-default mr-1 float-l">
                      Departments
                    </button>
                  </div>
