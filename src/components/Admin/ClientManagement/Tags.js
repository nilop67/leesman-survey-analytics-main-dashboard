...
const Tags = (props) => {
  ...
  const emptyTag = {
    emptyText: <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description={"No tag to show"}></Empty>,
  };
  const emptyParent = {
    emptyText: <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description={"No tag parent to show"}></Empty>,
  };
  ...
  return (
    <>
      <div className="container-fluid clients-page new-2022_class">
            ...
            <div className="col-md-12 col-sm-12">
              ...
              <ul className="nav nav-tabs3 mt-4 mb-2">
                <li className="nav-item">
                  <a
                    className={`nav-link ${selectedTab === "tags" && " active"}`}
                ...
                {!clientId && (
                  <li className="nav-item">
                    <a
                      className={`nav-link ${selectedTab === "parents" && " active"}`}
          ...
          <div className="col-xl-12 col-lg-12 col-md-12">
            <div className="row mb-4 page-__header">
              <div className="col-xl-6 col-lg-6 col-md-6">
                ...
                <span className="text-table-info">Total: {buffer.length} tags</span>
              </div>
        ...
        <div className={`modal fade bd-example-modal-lg ${state.openModal === "new-tag" ? " d-block show" : ""}`}>
          <TagModal scope={props.location.scope} selectedTag={selectedTag} close={closeGroups} parents={parents}></TagModal>
        </div>
        <div className={`modal fade bd-example-modal-lg ${state.openModal === "new-parent" ? " d-block show" : ""}`}>
          <ParentModal
            themes={themes}
