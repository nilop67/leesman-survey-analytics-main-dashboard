...
export default function QuestionModal({ selectedQuestion, close }) {
  ...
  function selectOptionsBasedOnRules(rule) {
    ...
    let arr = { A1: a1, A2: a2, F1: f1, F2: f2, F11: f11, F3: f3, F4: f4, I1: i1, I2: i2, I3: i3 };
      ...
      <div className="modal-content" style={{ padding: "15px" }}>
        <div className="row clearfix">
          <div className="col-lg-12 col-md-12">
            <button
              ...
              className={`btn btn-sm btn-default mr-1 float-l ${selectedTab === "question" ? "active" : ""}`}
            >
              Question settings
            </button>
            <button
              onClick={() => setSelectedTab("option")}
              className={`btn btn-sm btn-default mr-1 float-l ${selectedTab === "option" ? "active" : ""}`}
            >
              Option settings
            </button>
          </div>
        ...
        {selectedTab === "question" && (
          <div className="row clearfix centered-_row">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div className="card">
                <h2 className="card-title mb-0">Additional campaign question edit/update</h2>
              </div>
            </div>
            ...
            {types.length > 0 && String(formData.type_id) === String(types.filter((i) => i.name === "boolean_scale")[0].id) && (
              <div className="col-lg-12 col-md-12 col-sm-12">
                <label className="light-black" style={{ marginBottom: "15px" }}>
                  Question label 2
                </label>
            ...
            <div className="col-lg-3 col-md-3 col-sm-12" style={{ marginBottom: "15px" }}>
              <div className="form-group">
                <select value={formData.type_id} onChange={change} name="type_id" className="form-control show-tick">
            ...
            <div className="col-lg-3 col-md-3 col-sm-12" style={{ marginBottom: "15px" }}>
              <div className="form-group">
                <select value={formData.section_id} onChange={change} name="section_id" className="form-control show-tick">
            ...
            <div className="col-lg-3 col-md-3 col-sm-12" style={{ marginBottom: "15px" }}>
              <div className="form-group">
                <select value={formData.rule} onChange={change} name="rule" className="form-control show-tick">
            ...
            <div className="col-lg-3 col-md-3">
              <label className="fancy-checkbox">
                <input disabled checked={options.includes("neutral")} onChange={changeOption} type="checkbox" name="neutral" />
                <span className="light-black">Neutral option</span>
              </label>
            </div>
            <div className="col-lg-3 col-md-3">
              <label className="fancy-checkbox">
                <input checked={options.includes("behavioural")} onChange={changeOption} type="checkbox" name="behavioural" />
            ...
            <div className="col-lg-3 col-md-3">
              <label className="fancy-checkbox">
                <input checked={options.includes("neverAskFirst")} onChange={changeOption} type="checkbox" name="neverAskFirst" />
            ...
            <div className="col-lg-3 col-md-3">
              <label className="fancy-checkbox">
                ...
                />
                <span className="light-black">Location question asked at the end</span>
              </label>
            </div>
            {locations
              ...
              .map((i) => {
                return (
                  <div className="col-lg-3 col-md-3">
                    <label className="fancy-checkbox">
                      <input checked={dependencies.includes(i.id)} onChange={() => changeDependency(i.id)} type="checkbox" />
            ...
            <div className="col-lg-12 col-md-12" style={{ marginBottom: "20px", marginTop: "20px" }}>
              <label className="text-leftt light-black">Select Modules(s)</label>
              <MultiSelect
        ...
        {selectedTab === "option" && (
          <div className="row clearfix centered-_row">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div className="card">
                <h2 className="card-title mb-0">Question options edit/update</h2>
              </div>
            </div>
            ...
            <div className="scrollable--content col-lg-12">
              <div className="row">
                ...
                <div className="col-lg-2 col-md-2 col-sm-2 form-group">
                  <button type="button" onClick={sendNewOption} className="btn btn-sm btn-primary">
                    Save
                  </button>
                </div>
                {questionOptions
                      ...
                      <>
                        <div className="col-lg-8 col-md-8 col-sm-8 form-group">
                          <input
                            type="text"
                            value={i.label}
                            onChange={(e) => changeQuestionOption("label", i.id, e.target.value)}
                            className="form-control"
                            placeholder="Question heading "
                          />
                        </div>
                        <div className="col-lg-2 col-md-2 col-sm-2 form-group">
                          <input
                            type="number"
                            value={i.position}
                            onChange={(e) => changeQuestionOption("position", i.id, e.target.value)}
                            className="form-control"
                            placeholder="Question heading "
                          />
                        </div>
                        <div className="col-lg-2 col-md-2 col-sm-2 form-group">
                          <input
                            type="text"
                            value={i.type}
                            onChange={(e) => changeQuestionOption("type", i.id, e.target.value)}
                            className="form-control"
                            placeholder="Question code "
                            onFocus={() => {
                              if (i.type && i.type.length > 0) {
                                document.getElementById("warningMessage" + i.id + i.label).innerHTML =
                                  "Changing this value may cause some errors.";
                              }
                            }}
                          />
                          <p style={{ color: "red" }} id={"warningMessage" + i.id + i.label}></p>
                        </div>
                      </>
                    );
                  })}
