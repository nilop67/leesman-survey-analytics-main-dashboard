  ...
  function send() {
    if (title.length < 1) {
      ...
      if (!isEdit) {
        ...
        axios
          .post("/admin/clients/" + localStorage.getItem("selectedClientId") + "/helpdesk", data)
          .then((res) => {
            props.close();
          })
        ...
        axios
          .put("/admin/clients/" + localStorage.getItem("selectedClientId") + "/helpdesk/" + isEdit, data)
          .then((res) => {
            props.close();
          })
          .catch((err) => console.log(err));
    ...
    <div className="modal-dialog modal-lg modal-dialog-centered">
      <div className="modal-content" style={{ padding: "15px" }}>
        <div className="row clearfix">
          ...
          <div className="col-lg-6 col-md-6">
            <div className="form-group text-leftt">
              <label className="text-leftt light-black">Select location(s)</label>
              <MultiSelect
        ...
        <div className="row clearfix">
          ...
          <div className="col-12 pt-40">
            <button type="button" data-dismiss="modal" onClick={() => send()} className="btn btn-sm btn-primary">
              Save
            </button>
            <button
              type="button"
