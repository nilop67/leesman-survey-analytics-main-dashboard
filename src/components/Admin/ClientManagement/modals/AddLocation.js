...
import { getRegionByShortCountryCode } from "../../../../util/functions";
...
function AddLocation(props) {
    ...
    if (props.selectedLocation.key) {
      ...
      let f = {
        ...
        region_id: d.region_id
          ? d.region_id
          : d.country_id
          ? props?.regionData?.countries?.filter((o) => o.id === d.country_id)[0]?.region_id
          : null,
  ...
  const change = (e) => {
    ...
    if (name === "numberOfFloors" || name === "targetPopulation" || name === "area") {
  ...
  const send = () => {
    if (formData.name && formData.country_id && (!props.inside_enabled || formData.targetPopulation)) {
      ...
      notification.warning({ message: "Please fill required areas.(name,country,city,target population" });
    }
  };
  const edit = () => {
        ...
        <div className="row clearfix">
          <div className="col-lg-12 col-md-12 col-sm-12">
            <div className="card">
              <h2 className="card-title mb-0">
                {props.selectedLocation.key ? "Location:" + props.selectedLocation.name : "Add new location"}
              </h2>
            </div>
          </div>
          ...
          <div className="col-lg-12 col-md-12">
            <button
              ...
              className={`btn btn-sm btn-default mr-1 float-l ${selectedTab === "location" ? "active" : ""}`}
            >
              Location settings
            </button>
            {props.selectedLocation?.key && (
              <button
                ...
                className={`btn btn-sm btn-default mr-1 float-l ${selectedTab === "floors" ? "active" : ""}`}
              >
                Floors
              </button>
            )}
          ...
          {selectedTab === "location" ? (
            <>
              ...
              <div className="col-lg-3 col-md-4 col-sm-12">
                <div className="form-group">
                  <select name="region_id" disabled value={formData.region_id} className="form-control show-tick">
                    ...
                    onChange={(e) => {
                      setFormData((pre) => {
                        return {
                          ...
                          region_id: props?.regionData?.countries?.filter((i) => i.id === e.target.value)[0]?.region_id,
                        };
                      });
                    }}
                    name="country_id"
              ...
              <div className="col-lg-3 col-md-4 col-sm-12">
                <div className="form-group">
                  <select onChange={change} name="city_id" className="form-control show-tick" placeholder="Select Country First">
                ...
                <div className="col-lg-6 col-md-4 col-sm-12">
                  <div className="form-group">
                    <input
                      type="number"
                      className="form-control"
                      placeholder="Leesman inside target population "
              ...
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="Satellite business park">Satellite business park</option>
              ...
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="form-group">
                  ...
                  >
                    ...
                    {["Heritage", "Pre 50s", "50s - 80s", "80s - 2000", "Post millenium", "Other"].map((o) => {
              ...
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="Multiple occupants">Multiple occupants</option>
                    <option value="Other">Other</option>
                  </select>
                </div>
              </div>
              ...
              <div className="col-lg-6 col-md-6 col-sm-12">
                <Tooltip title="Date of organisation moved in">
                  <DatePicker
                    ...
                    onChange={(a, b) => {
                      setFormData((pre) => {
                        return { ...pre, date_organisation_moved_in: b.splitDate() };
                      });
                    }}
                    showToday
              ...
              <div className="col-12 pt-40">
                <button
                  type="button"
                  data-dismiss="modal"
                  onClick={() => (props.selectedLocation.key ? edit() : send())}
