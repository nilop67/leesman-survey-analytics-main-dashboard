        ...
        <div className="slider__div">
          <Range
            ...
            renderMark={({ props, index }) => (
              <div className="slider--render-mark" {...props} style={{ ...props.style, backgroundColor: "#C4C4C4" }} />
            )}
            ...
            renderThumb={({ props, isDragged }) => (
              <div className="slider_thmb square" {...props} style={{ ...props.style }}>
                <div className="middle" style={{ backgroundColor: isDragged ? "#fff" : "#449FDD" }} />
              </div>
            )}
          />
