...
const DefaultLink = ({ itemProps, isSetLogout, setLogout, ...props }) => {
  ...
  const onRemoveClick = () => {
    if (
      ...
      document.querySelector("#location-_link") && document.querySelector("#location-_link").classList.remove("active");
  ...
  const onMainRemoveClick = () => {
    if (document.querySelector("#campaigns-_link") !== null && document.querySelector("#comments-_link") !== null) {
      document.querySelector("#campaigns-_link") && document.querySelector("#campaigns-_link").classList.remove("active");
      document.querySelector("#comments-_link") && document.querySelector("#comments-_link").classList.remove("active");
    }
  };
  ...
  if (itemProps.id === "main" || itemProps.id === "app" || itemProps.id === "extra" || itemProps.id === "ui") {
  ...
  } else if (itemProps.to === "/campaigns" || itemProps.to === "/all-campaigns") {
    return (
      <NavLink
        to={`${itemProps.to}`}
        id="campaigns-_link"
    ...
    return (
      <NavLink
        ...
        className={`hidden-xl-visible main-link ${itemProps.hasSubMenu ? "has-arrow" : ""}`}
      >
        <i className={itemProps.children[0].props.className}></i>
        <span>{itemProps.label}</span>
      </NavLink>
    ...
    return (
      <NavLink
        ...
        className={`responder-ghost-link ${itemProps.hasSubMenu ? "has-arrow" : ""}`}
      >
        <i className={itemProps.children[0].props.className}></i>
        <span>{itemProps.label}</span>
      </NavLink>
