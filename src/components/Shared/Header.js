...
const Header = ({
  ...
  return (
    <>
      <LogoutModal setLogoutModal={setLogoutModal} isLogoutModal={isLogoutModal} letLogout={letLogout} />

      <Modal
        className={`${!role && lightVersion ? "responder-logout-modal" : "others-logout-modal"} `}
        title="Log out"
        centered
        visible={isSetLogout}
        // visible={visible}
        ...
        <div className="container-fluid leesman__header">
          <div className="navbar-left">
            <div className="navbar-btn">
              {!role ? (
                ...
                <>
                  <Link to={"/"} onClick={() => setBurgerMenu(false)} className="admin-logo">
                    <img src="/assets/images/svg-images/leesman-logo-admin.svg" alt="Leesman Logo" className="img-fluid logo" />
                  </Link>

                  <div className={`change__module ${isOpenModule ? " open" : ""} `}>
                    <div className="module__items">
                      <div onClick={() => { setChangeModule(isChangeModule === "Inside" ? "Surveys" : "Inside"); setOpenModule(false); goInside() }} className="select__item">{isChangeModule === "Inside" ? "Surveys" : "Inside"}</div>
              ...
              {!role ? (
                <>
                  <div id="responder-_-burger" className={!burgerLines ? " " : "open-_-burger"}>
                    ...
                    <button
                      ...
                      className={`responder--menu-btn cursorp ${burgerLines ? " clicked" : ""}`}
                    >
                      <i className="icont-accountxc"></i>
                    </button>
                    <ul className="responder-_-sub-menu">
                      <li>
                        <Link to="/my-account" className="item-_-link" onClick={() => setBurgerMenu(false)}>
                          <i className="icon_a-editticon_a-" aria-hidden="true" title="Pencil icon"></i> Edit profile
                        </Link>
                      </li>
                      <li>
                        <Link to="/change-password" className="item-_-link" onClick={() => setBurgerMenu(false)}>
                          <i className="icon_a-passworddicon_a-" aria-hidden="true" title="Lock icon"></i> Change password
                        </Link>
                      </li>
                      <li>
                        <Link to="/alert-settings" className="item-_-link" onClick={() => setBurgerMenu(false)}>
                          <i className="icon_a-alertssicon_a-" aria-hidden="true" title="Alert icon"></i> Alert settings
                        </Link>
                      </li>
                      {/* <li>
                        <Badge
                      ...
                      <li>
                        ...
                        >
                          <i className="icont-logoutxc" aria-hidden="true" title="Power icon"></i> Logout
                        </a>
                      </li>
                    </ul>
                  </div>
                ...
                <>
                  <button type="button" className="btn-toggle-offcanvas btn-menu-l inside_mobile_btn" onClick={() => setOffcanvas(!offcanvas)}>
          ...
          <div className="navbar-center">
            <div className="">
              <div className="n_menu_horizontal header">
                <NavLink to="/surveys-management" className={`${({ isActive }) => (isActive ? ' active' : ' ')}${window.location.pathname === "/create-survey" ? ' active' : ' '}`} onClick={() => setMenu("")}>Surveys</NavLink>
                <NavLink to="/analytics-overview" className={`${({ isActive }) => (isActive ? ' active' : ' ')}${window.location.pathname === "/analytics-results" ? ' active' : ' '}`} onClick={() => setMenu("")}>Results</NavLink>
                <NavLink to="/custom-filters" className={({ isActive }) => (isActive ? ' active' : ' ')} onClick={() => setMenu("")}>Custom</NavLink>
                <NavLink to="/clients-management" className={`${({ isActive }) => (isActive ? ' active' : ' ')}${window.location.pathname === "/client-settings" ? ' active' : ' '}`} onClick={() => setMenu("")}>Clients</NavLink>
              </div>
          ...
          <div className={`navbar-right ${!role ? "responder-top-right" : ""}`}>
            ...
            <div className="icon_menu_horizontal header">
              <NavLink to="/" className={({ isActive }) => (isActive ? ' active' : ' ')}><span className="cxv-home-l-icn"></span></NavLink>

              {/*<a href="javascript:void(0)" */}
              <div
                className={`has__drop 
                ${isAdminDrop ? " opened" : ""} 
                ${window.location.pathname === "/supporting-docs" ? ' active' : ' '}
                ${window.location.pathname === "/modules-analytics" ? ' active' : ' '}
                ${window.location.pathname === "/translations-admin" ? ' active' : ' '}
                `} onClick={() => setAdminDrop(!isAdminDrop)} >

                <span ref={refHeaderDropLink} className="header_drop_select_item cxv-admin-l-icn"></span>

                <div className={` dropped__menu ${isAdminDrop ? " show" : ""} `}>
                      ...
                      <li className="has__sub_list">
                        ...
                        <div className="sub__list">
                          ...
                          <ul>
                            ...
                            <li><NavLink to="/modules-analytics">Modules</NavLink></li>
                            <li><NavLink to="/translations-admin">Translations</NavLink></li>
                          </ul>
                        </div>
                      </li>
                      <li><NavLink to="/supporting-docs" className={({ isActive }) => (isActive ? ' active' : ' ')}>Supporting docs</NavLink></li>
                      <li><NavLink to="/logs-admin">Logs</NavLink></li>
              ...
              <NavLink to="/all-settings" className=""><span className="cxv-settings-l-icn"></span></NavLink>
              <a href="#!" className=""><span className="cxv-help-l-icn"></span></a>
              <a onClick={() => setLogoutModal(true)} className="cursorp"><span className="cxv-logout-l-icn"></span></a>
            </div>
              ...
              <ul className="nav navbar-nav">
                {!role ? (
                  <>
                    ...
                    <li>
                      <a onClick={() => toggleNotificationBar(true)} className="cursorp">
                  ...
                  <>
                    ...
                    <li>
                      <Link
                        ...
                        className={`cursorp ${window.location.pathname === "/responder-home" ? " active-btn" : ""}`}
                      >
                    ...
                    <li>
                      <Link
                        ...
                        className={`cursorp ${window.location.pathname === "/questions" ? " active-btn" : ""}`}
                      >
                    ...
                    <li>
                      <Link
                        ...
                        className={`cursorp ${window.location.pathname === "/tags" ? " active-btn" : ""}`}
                      >
                    ...
                    <li>
                      <Link
                        onClick={onRemoveClick}
                        to="/clients"
                        className={`cursorp ${window.location.pathname === "/clients" ||
                    ...
                    <li>
                      <Link
                        ...
                        className={`cursorp ${window.location.pathname === "/campaigns-management" ? " active-btn" : ""}`}
                      >
                    ...
                    <li>
                      <Link
                        ...
                        className={`cursorp ${window.location.pathname === "/survey-management" ? " active-btn" : ""}`}
                      >
                    ...
                    <li>
                      <Link
                        onClick={onRemoveClick}
                        to="/user-management"
                        className={`cursorp ${window.location.pathname === "/user-management" ? " active-btn" : ""}`}
                      >
                ...
                {role === "Leesman Admin" || role === "Super Admin" ? (
                  <>
                    <li>
                      <Link to="/logs" className={`cursorp ${window.location.pathname === "/logs" ? " active-btn" : ""}`}>
                    ...
                    <li>
                      <Link
                        to="/migration"
                        className={`cursorp ${window.location.pathname === "/migration" ? " active-btn" : ""}`}
                      >
                ...
                <li>
                  <Link
                    onClick={onRemoveClick}
                    to="/my-account"
                    className={`cursorp ${window.location.pathname === "/my-account" ||
...
const mapDispatchToProps = (dispatch) => ({
  ...
  toggleNotificationBar: (e) => dispatch(settingsActions.toggleNotificationBar(e)),
