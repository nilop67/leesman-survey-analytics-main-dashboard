  ...
  function getData() {
    ...
    dispatch(feedBackResultActions({fdata}) )
        ...
        if ( dataAvailable) {
          ...
          let themeArr  = highAndLows.sort((a, b) => new Date(a.score) - new Date(b.score));
        ...
        <div className="block-header">
          <div className="row clearfix control--nav">
            <div className="col-md-3 col-sm-12 user-feedback-top">
              <h1>Comments</h1>
              <p className="small-_info for-title">Self-initiated feedback submitted as a free response</p>
            </div>
          ...
          <div className="col-md-12 col-sm-12 mb-3">
            <ul className="nav">
              <li className="nav-item mr--8">
                <Link to="/results-feedbacks" className="btn btn-default active btn-block">
                  Summary
                </Link>
              </li>
              <li className="nav-item mr--8">
              ...
              <li className="nav-item mr--8">
                <Link to="/feedback-data-view" className="btn btn-default btn-block">
                  Theme breakdown
                </Link>
              </li>
              ...
              <div className="body min-h-357">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">Percentage of positive comments</p>
                  </div>
                </div>
                      ...
                      <div className="donut-new donut-new-main" style={{ height: "200px" }}>
                        ...
                        >
                          ...
                          <div className="indicator">
                            ...
                            <div>{parseFloat(donutData).toFixed(1) >= 0 ? parseFloat(donutData).toFixed(1) : 0}%</div>
                          </div>
                        </ProgressBar>
                      </div>
                    )}
                    ...
                    <div className="row align-items-center h-100 highest_-items text-left">
                      <div className="col-lg-12 col-sm-12">
                        <div className="let_-center">
                          <label className="mb-0 font-1r text-left mb-2">Theme with the highest Comments Score</label>
                          <h4 className="card-title mb-0 text-white text-left">
                            {high && (
                              <>
                                <span className="text-success">{parseFloat((highScore + 100) / 2).toFixed(1)}%</span>
                                &nbsp;&nbsp; {high}
                              </>
                            )}
                          </h4>
                      ...
                      <div className="col-lg-12 col-sm-12">
                        <div className="let_-center">
                          <label className="mb-0 font-1r text-left mb-2">Theme with the lowest Comments Score</label>
                          <h4 className="card-title mb-0 text-white text-left">
                            {low && (
                              <>
                                <span className="text-danger">{parseFloat((lowScore + 100) / 2).toFixed(1)}%</span>&nbsp;&nbsp;{" "}
                                {low}
                              </>
                            )}
                          </h4>
              ...
              <div className="body min-h-357">
                ...
                <div className="row text-center">
                  <div className="col-lg-12">
                    {isLoading ? <Loader /> : siScoreData && siScoreData.series && <SiScore data={siScoreData} />}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-6 col-md-12 leesman-section">
            <div className="card">
              <div className="body min-h-357">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    <h2 className="card-title mb-0">No. of comments versus employees</h2>
                    <p className="small-_info">Breakdown of positive and negative comments and by which group of employees</p>
                  </div>
                </div>

                <div className="row text-center">
                  <div className="col-lg-12">{isLoading ? <Loader /> : <CommentsNumber data={commentsNumber} />}</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="body min-h-357">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">Number of positive and negative comments broken down by location</p>
                  </div>
                </div>

                <div className="row text-center">
                  <div className="col-lg-12">{isLoading ? <Loader /> : <LocationBreakDown data={locationBreakDownData} />}</div>
                </div>
              </div>
            </div>
          </div>
