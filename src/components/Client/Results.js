...
const Results = (props) => {
  ...
  const { isLoading, error, avg, donut, campaignCharts, usage, comments } = useSelector(store => store.results)
  ...
  useEffect(() => {
    if (document.querySelector("#campaigns-_link") !== null) {
      document.querySelector("#campaigns-_link") && document.querySelector("#campaigns-_link").classList.remove("active");
    }
    if (document.querySelector("#comments-_link") !== null) {
      document.querySelector("#comments-_link") && document.querySelector("#comments-_link").classList.remove("active");
    }
  }, []);
  ...
  const getData = () => {
    ...
    if (props.location.location_id) {
      fdata = { ...filterData, page: "summary", locations: [props.location.location_id] };
    } 
              ...
              <div className="body min-h-357">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">How employees are feeling about their work environments</p>
                  </div>
                </div>
                  ...
                  <div className="row text-center">
                        ...
                        <div className="donut-new donut-new-main" style={{ height: "200px" }}>
                          ...
                          >
                            ...
                            <div className="indicator">
                              {/* XP score = X.X */}
                              <div>{parseFloat(avg).toFixed(1) > 0 ? <>{avg && parseFloat(avg).toFixed(1)}</> : "0"}</div>
                            </div>
                          </ProgressBar>
                          <p className="small-_info text-leftt">
                            Percentage of employees who feel positively about their work environment
                          </p>
                        </div>
                      ) : (
                        <NoData></NoData>
                    ...
                    <div className="col-lg-6 pd-r-zero">
                      ...
                      {donut.reduce(add, 0) >= 1 ? (
                        <p className="small-_info breakdown-_info">Breakdown of all positive and negative responses</p>
                      ) : (
              ...
              <div className="body card-bottom-section">
                <div className="row">
                  <div className="col-lg-12 col-sm-12">
                    <Link to="/organisation-xp-score" className="mb-0 card-link">
                      View dashboard
              ...
              <div className="body min-h-357">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">How employees are engaging with the platform</p>
                  </div>
                </div>

                <div className="row text-center">
                  <div className="col-lg-12">{isLoading ? <Loader /> : <DailyActiveUsers data={usage} />}</div>
                </div>
              </div>
              ...
              <div className="body min-h-337">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">Sets of questions aimed to explore a particular topic in more depth</p>
                  </div>
                </div>
                                  ...
                                  <div className="donut-new donut-new-main" style={{ height: "180px" }}>
                                    ...
                                    >
                                      ...
                                      <div className="indicator xl-small">
                                        <div>{i.avg >= 0 ? parseFloat(i.avg).toFixed(1) : "0"}%</div>
                                      </div>
                                    </ProgressBar>
                                    ...
                                    <span className="mb-0 sub-title donut-txt-b">
                                      Status: {i.status}
                                      <br />
                                      {i.end === "Always on" ? "" : "Close date:" + i.end}
                                    </span>
                                  </div>
                                </div>
                              );
              ...
              <div className="body card-bottom-section min-h-51">
                <div className="row">
                  ...
                  <div className="col-lg-6 col-sm-12">
                    <Link
                      to={role === "Super Admin" || role === "Leesman Admin" ? "/all-campaigns" : "/campaigns"}
              ...
              <div className="body min-h-337">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">Self-initiated feedback submitted as a free response</p>
                  </div>
                </div>

                <div className="row text-center">
                  <div className="col-lg-12">{isLoading ? <Loader /> : <SiScore data={comments} />}</div>
                </div>
              </div>
