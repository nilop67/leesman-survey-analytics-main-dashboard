        ...
        <div className="block-header">
          <div className="row clearfix control--nav">
            <div className="col-md-3 col-sm-12">
              <h1>Usage</h1>
              <p className="small-_info for-title">How employees are engaging with the platform</p>
            </div>
                ...
                {loading ? (
                  ...
                  <>
                    <div className="m-0 text-center h4 light-black">
                      {stats.active_users > 0 ? <>{stats.active_users}</> : errorMessage}
                    </div>
                    <div className="text-centerr light-black">Active users today</div>
                  </>
                )}
              </div>
            </div>
            ...
            <div className="card">
              <div className="body">
                {loading ? (
                  ...
                  <>
                    <div className="m-0 text-center h4 light-black">
                      {stats.engegament > 0 ? <>{stats.engegament && stats.engegament + "%"}</> : errorMessage}
                    </div>
                    <div className="text-centerr light-black">User engagement</div>
                  </>
                )}
              </div>
            </div>
            ...
            <div className="card">
              <div className="body">
                {loading ? (
                  ...
                  <>
                    <div className="m-0 text-center h4 light-black">
                      {stats.responses > 0 ? <>{stats.responses}</> : errorMessage}
                    </div>
                    <div className="text-centerr light-black">Responses in campaigns</div>
                  </>
                )}
              </div>
            </div>
            ...
            <div className="card">
              <div className="body">
                {loading ? (
                  ...
                  <>
                    <div className="m-0 text-center h4 light-black">
                      {stats.comments > 0 ? <>{stats.comments}</> : errorMessage}
                    </div>
                    <div className="text-centerr light-black">Comments logged</div>
                  </>
                )}
              </div>
            </div>
              ...
              <div className="body min-h-357">
                ...
                <div className="row text-center">
                  <div className="col-lg-12 toolbar-_active-users">
                    {loading ? <Loader /> : <DailyActiveUsers data={activeUsersData} />}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="body min-h-357">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">Total number of submitted comments and responses broken down by location</p>
                  </div>
                </div>

                <div className="row text-center">
                  <div className="col-lg-12 scrollable-_charts">
                    {loading ? <Loader /> : <LocationBreakDownWave data={locationBreakdownData} />}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="body min-h-357">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">Average number of logins in a given timeframe</p>
                  </div>
                  {loading ? (
                    <></>
                  ) : (
                    <>
                    {loginDaysData[String(selectedDateFilter)]?.series?.length>0 &&
                ...
                <div className="row text-center">
                  <div className="col-lg-12">
                    {loading ? <Loader /> : <AverageLogins data={loginDaysData[String(selectedDateFilter)]} setAvgDateFilter={setAvgDateFilter}/>}
                  </div>
                </div>
              </div>
            </div>
