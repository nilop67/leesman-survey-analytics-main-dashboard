...
const FeedbackThemeView = () => {
  ...
  const {
    scales, error
  } = useSelector(store => store.feedBackThemeView)

  
  useEffect(() => {
    if (window.location.pathname === "/feedback-theme-view" && document.querySelector("#comments-_link") !== null) {
              ...
              <div className="feedback-section">
                <div className="row clearfix pn-padding">
                  ...
                  <div className="col-6">
                    ...
                    <h6 className="score-title-right">{parseFloat(item.score.toFixed(0)).toFixed(1) + "%"}</h6>
                  </div>
                </div>
                ...
                <>
                  <div className="progress progress-feedback">
                    ...
                    >
                      <span className={`iconx-triangle-down ${decideColor(item.score, "arrow")}`}></span>
                    </div>
                  </div>

                  <div className="progress progress-lg prog-feed">
                    <div
                      className={`progress-bar progress-bar-feedback ${decideColor(item.score, "bar")}`}
                      role="progressbar"
                      aria-valuenow={parseInt(item.score)}
                      aria-valuemin={-100}
                      aria-valuemax={100}
                ...
                <div className="row clearfix pn-padding">
                  <div className="col-6">
                    <h6 className="score-title-left feedback-rl-title">Negative</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="score-title-right feedback-rl-title">Positive</h6>
                  </div>
                </div>
              </div>
                        ...
                        .map((i) => {
                          return (
                            <li className="nav-item">
                              <span className="feedback-tag">{i.tag_label}</span>
                            </li>
                          );
                        })}
                    </ul>
            ...
            <div className="body card-bottom-section feed-bottom-s">
              <div className="row">
                <div className="col-lg-12 col-sm-12">
                  <Link to="/feedback-comments-view" className="mb-0 card-link float-r">
                    View comments
        ...
        <div className="block-header">
          <div className="row clearfix control--nav">
            <div className="col-md-3 col-sm-12 user-feedback-top">
              <h1>Comments</h1>
              <p className="small-_info for-title">Tags submitted with each comment are organised into themes shown below</p>
            </div>
        ...
        <div className="row clearfix theme-views-row">
          <div className="col-md-12 col-sm-12 mb-3">
            <ul className="nav">
              ...
              <li className="nav-item mr--8">
                <Link to="/feedback-theme-view" className="btn btn-default active btn-block">
                  Themes
                </Link>
              </li>
              <li className="nav-item mr--8">
              ...
              <li>
                <ImportExport refresh={getData} type={"tag-themes"} data={scales} import={false} export={true} hideLine={true} />
              </li>
            </ul>
          </div>
