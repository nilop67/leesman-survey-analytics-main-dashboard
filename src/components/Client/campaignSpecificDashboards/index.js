...
import { campaignCommonPart, campaignFilter, campaignSectionAll } from "../../common/commonComponents/CommonBlocks";
const CampaignClosedDetails = () => {
  ...
  useEffect(() => {
    if (window.location.pathname === "/campaign-details" && document.querySelector("#campaigns-_link") !== null) {
      document.querySelector("#campaigns-_link").classList.add("active");
    }
  }, []);
  const search = window.location.search;
  const params = new URLSearchParams(search);
  const campaign_id = params.get("campaign_id") ? params.get("campaign_id") : window.history.back();
  ...
  useEffect(() => {
    query.length > 3 &&
      customfilter(query, commentData, ["locationType", "question", "section_label", "message"], bufferCommentData);
  }, [query]);
    ...
    <>
      ...
      <div className="container-fluid">
        ...
        <div className="row clearfix">
              ...
              <div className="body min-h-357 campaign-score-body">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="small-_info">Percentage of total positive responses to all questions in the campaign</p>
                  </div>
                  {/* <ul className="nav">
          ...
          <div className="col-lg-9 col-md-12 leesman-section">
            <div className="card">
              <div className="body min-h-357">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    <h2 className="card-title mb-0">{campaignDetails?.always_on ? "Overview" : "Campaign details"}</h2>
                  </div>
                </div>
          ...
          {data.available && (!moment(campaignDetails.end_date).isBefore(moment()) || campaignDetails.always_on) ? (
              ...
              <div className="card">
                <div className="body min-h-alldata-campaigns">
                  <div className="row text-center">
                          ...
                          {categoryType === "trends" ? (
                            <>
                              <label className="fancy-radio min-w-168">
                                <input
                                  onClick={() => setChartType("individual-chart")}
                                  type="radio"
                                  name="chart-type"
                                  value="individual-chart"
                                  checked={chartType === "individual-chart" ? "checked" : ""}
                                />
                                <span className="light-black">
                                  <i></i>Individual
                                </span>
                              </label>
                              <label onClick={() => setChartType("combined-chart")} className="fancy-radio min-w-168">
                                <input
                                  type="radio"
                                  name="chart-type"
                                  value="combined-chart"
                                  checked={chartType === "combined-chart" ? "checked" : ""}
                                />
                                <span className="light-black">
                                  <i></i>Combined
                                </span>
                        ...
                        <div className="col-lg-12 col-md-12 pt-10">
                          <div className="form-group text-leftt">
                            ...
                            >
                              ...
                              {[...new Set(basicBarData.sections)].map((item) => {
                          ...
                          <div className="col-lg-12 col-md-12">
                            <div className="form-group text-leftt">
                              ...
                              <select onChange={(e) => setOrderBy(e.target.value)} value={orderBy} className="form-control">
                                ...
                                <option value="positivity_desc">Positivity (Decreasing)</option>
                    ...
                    {chartType !== "comments" ? (
                      campaignCommonPart(chartType, loading, orderBy, basicBufferData, heatBufferData, bufferRates, bufferTrends)
                    ) : (
                      <div className="col-lg-12 pt-20 scrollable-_charts">
                        {chartType === "comments" && <Table dataSource={bufferCommentData} columns={columns} />}
                      </div>
                    )}
                  </div>
                </div>
            ...
            <>
              <div className="col-md-12 col-sm-12">
                ...
                <nav className="d-flex text-muted top-icons-bar float-rightt">
                  ...
                  <a className="icon mr-3">
                    <i className="iconx-brightness_1 icon-orange" /> 20.1 - 40.0%
                  </a>
                  <a className="icon mr-3">
                    <i className="iconx-brightness_1 icon-orange-soft" /> 40.1 - 60.0%
                  </a>
                  <a className="icon mr-3">
                    <i className="iconx-brightness_1 icon-green-soft" /> 60.1 - 80.0%
                  </a>
                  <a className="icon mr-3">
                    <i className="iconx-brightness_1 icon-green" /> 80.1 - 100.0%
                  </a>
                </nav>
              </div>
              {data &&
                        ...
                        <div className="card">
                          <div className="body min-h-290">
                            ...
                            <div className="score-section">
                              <div className="row clearfix">
                                <div className="col-6">
                                  <h6 className="score-title-left">Current score</h6>
                                </div>
                                <div className="col-6">
                            ...
                            <div className="response-section">
                              <div className="row clearfix">
                                <div className="col-6">
                                  <h6 className="score-title-left">Response rate</h6>
                                </div>
                                <div className="col-6">
