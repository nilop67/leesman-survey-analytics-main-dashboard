...
const RegionsGlobal = ({ setLightTheme, lightVersion, setLoginBackground, reduxFilterData, regionsGlobalData }) => {
  useEffect(() => {
    if (window.location.pathname === "/") {
      if (document.querySelector("#location-_link") !== null) {
        document.querySelector("#location-_link") && document.querySelector("#location-_link").classList.add("active");
      }
      ...
      <div className="container-fluid">
        ...
        <div className="row clearfix">
          <div className="col-lg-12 col-md-12 leesman-section">
            ...
            <MapBox reduxFilterData={reduxFilterData} data={regionsGlobalData} useWindowDimensions={useWindowDimensions} key={width + height} />
          </div>
        </div>
      </div>
    </>
