        ...
        signUp(email, password, inviteCode)
          .then(() => {
            notification.success({
              message: "Please confirm account by using the link sent to your email",
            });
            props.history.push("/login");
          })
          .catch((e) => {
            ...
            <div className="col-lg-6">
              <div className="lssman-_r-content">
                ...
                <div className="fxt-form">
                  <div className="form-group">{commonAuthItem(change, formData, "email", submit)}</div>
                  <div className="form-group">{commonAuthItem(change, formData, "password", submit)}</div>
                  <div className="form-group">
                    {commonAuthItem(change, formData, "passwordConfirm", submit, "Confirm password")}
                  </div>
                  ...
                  <div className="form-group">
                    <button type="submit" onClick={submit} className="fxt-btn-fill">
                      Register
                    </button>
                  </div>
                </div>
