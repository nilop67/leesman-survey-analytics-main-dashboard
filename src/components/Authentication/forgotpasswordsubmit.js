            ...
            <div className="col-lg-6">
              <div className="lssman-_r-content">
                ...
                <div className="fxt-form">
                  <div className="form-group">{commonAuthItem(change, formData, "email", changePassword)}</div>
                  <div className="form-group">{commonAuthItem(change, formData, "code", changePassword)}</div>
                  <div className="form-group">{commonAuthItem(change, formData, "password", changePassword)}</div>
                  <div className="form-group">
                    {commonAuthItem(change, formData, "passwordConfirm", changePassword, "Confirm password")}
                  </div>
                  ...
                  <div className="form-group">
                    <button onClick={changePassword} className="fxt-btn-fill reset-_btn">
                      Update password
                    </button>
                  </div>
                </div>
