            ...
            <div className="col-lg-6">
              <div className="lssman-_r-content">
                ...
                <div className="fxt-form">
                  <div className="form-group">{commonAuthItem(change, formData, "email", signUp)}</div>
                  <div className="form-group">{commonAuthItem(change, formData, "password", signUp)}</div>
                  <div className="form-group">
                    {commonAuthItem(change, formData, "passwordConfirm", signUp, "Confirm password")}
                  </div>
                  <div className="form-group">
                    <label htmlFor="user-type" className="control-label sr-only">
                      User Type
                    </label>
                    <select className="form-control" name="user-type" id="user-type" onChange={changeType} defaultChecked="">
