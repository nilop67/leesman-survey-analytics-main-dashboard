...
import { setFullScreen, setLoginBackground, setOneTimeLoader } from "../../actions/settingsAction";
...
function Login(props) {
  ...
  return (
    <>
      <div className={`lessmn-_preloader ${props.isOneTimeLoader ? "" : " hidden-_loader"}`}>
        <AuthLogo />
        <p className="powered__-copyright">
          <span>powered by</span> <strong>Leesman &#174; |</strong> Leesmanindex.com
        </p>
      </div>
              ...
              <div className="lssman-_r-content">
                ...
                <div className="fxt-form">
                  <div className="form-group">
                    <label htmlFor="signin-email" className="input-label text-leftt">
                      Username
                    </label>
                    {commonAuthItem(change, formData, "email", route)}
                  </div>
                  <div className="form-group">
                    <label htmlFor="signin-password" className="input-label text-leftt">
                      Password
                    </label>
