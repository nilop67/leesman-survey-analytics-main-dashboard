...
class ExperienceScore extends Component {
  ...
  render() {
    let categories = this.props.data && this.props.data.weeks ? this.props.data.weeks : [];
    let options = {
      width: "100%",
      chart: {
        background:'#292b2b',
      ...
      xaxis: {
        //   type: 'datetime'
        tickAmount: categories.length >= 200 ? 5 : categories.length < 200 && categories.length >= 90 ? 15 : categories.length < 90 && categories.length >= 30 ? 10 : undefined,
