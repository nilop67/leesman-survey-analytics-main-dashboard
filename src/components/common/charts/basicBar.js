  ...
  render() {
    const sortByType = (type, series, responses, categories) => {
      ...
      if (type === "positivity") {
        ...
        return { series: sortByPositivity.map((i) => i.score), categories: sortByPositivity.map((i) => i.category) };
        ...
        return { series: sortByResponses.map((i) => i.respons), categories: sortByResponses.map((i) => i.category) };
    ...
    let data = {};
    if (this.props.data) {
      let d = sortByType(this.props.orderBy, this.props.data.series, this.props.data.responses, this.props.data.categories);
      ...
      data = {
        options: {
          ...
          tooltip: {
            ...
            y: {
              formatter: (value) => {
                return Math.round(value * 100) / 100 + `${this.props.orderBy === "responses" ? " people" : " %"}`;
              },
            },
          },
          legend: {
        ...
        series: [
          {
            name: `${this.props.orderBy === "responses" ? "Response count" : "% Positivity"}`,
            data: d.series,
          },
        ],
      };
        ...
        {this.props.data && this.props.data.categories.length >= 1 ? (
          <>
            ...
            <Chart
              ...
              type="bar"
              height={this.props.data.categories.length <= 1 ? 100 : this.props.data.categories.length * 30 + 100}
            />
          </>
        ) : (
          <NoData />
