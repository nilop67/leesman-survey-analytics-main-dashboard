...
class AverageLogins extends Component {
  ...
  render() {
    let series = this.props.data && this.props.data.series ? this.props.data.series : this.state.series;
        ...
        yaxis: [
          {
            ...
            label: {
              ...
              text: "Organisation XP Score:" + parseFloat(this.props.avg).toFixed(1),
              offsetX: 5,
            },
          },
        ],
    ...
    return (
      <div id="wrapper" className="mb-point-c internal-comp">
        <div id="chart-line">
          {/* {" "} */}
          {series[0].data.reduce((previousScore, currentScore, index) => previousScore + currentScore, 0) <= 0 &&
          series[1].data.reduce((previousScore, currentScore, index) => previousScore + currentScore, 0) <= 0 ? (
            <NoData />
          ) : (
