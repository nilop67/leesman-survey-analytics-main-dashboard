          ...
          xaxis: {
            ...
            tickAmount:
              this.props.data.categories.length >= 200
                ? 5
                : this.props.data.categories.length < 200 && this.props.data.categories.length >= 90
                ? 15
                : this.props.data.categories.length < 90 && this.props.data.categories.length >= 30
                ? 10
                : 0,
            categories: this.props.data.categories.map((item) => moment(item).format("DD MMM")),
            tooltip: {
              enabled: false,
            },
            labels: {
    ...
    return (
      <div id="chart">
        {this.props?.data?.series?.length >= 1 ? (
          <ReactApexChart options={data.options} series={data.series} type="area" height="250px" className="mb-point-c" />
        ) : (
          <NoData />
        )}
      </div>
