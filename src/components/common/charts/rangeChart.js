...
import { VictoryBoxPlot, VictoryChart, VictoryAxis, VictoryLabel, VictoryTooltip, VictoryVoronoiContainer } from "victory";
      ...
      <>
        <g style={{ pointerEvents: "none" }}>
          <foreignObject x={x - 40} y={y - 50} width="210" height="90">
            <div className="range--chart-tooltip" xmlns="http://www.w3.org/1999/xhtml">
  ...
  constructor(props) {
    ...
    this.state = {
      series: [
        ...
        { x: "Informal work areas/break-outzones", y: [48.5, 48.5, 69.5, 90.5, 90.5] },
