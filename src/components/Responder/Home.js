...
import { setBgImage, setLightTheme, setOffcanvas, setLoginBackground } from "../../actions/settingsAction";

// NE NE İŞE YARAR? - BURAYA TIKLARSANIZ ŞU OLUR FALAN İÇİN
const steps = [
  {
  ...
  },
  {
    ...
    content: ({ goTo, inDOM }) => (
      <div>
        <strong>We’ll occasionally nudge you to answer the a few questions.</strong>
        <br />
  ...
  },
  {
    ...
    content: ({ goTo, inDOM }) => (
      <div>
        <strong>Come here to rate your overall experience on a weekly basis</strong>
      </div>
    ),
    position: "bottom",
    action: (node) => {
...
const ResponderHome = ({ demographics, user, resetDemographics, setBgImage, setLightTheme, reduxClient }) => {
  ...
  // GEÇİCİ TEK SEFERLİK TUR FONKSİYONLARI
  // İLK VERİ INTRO.JS DE; sessionStorage.setItem("isTour", "true")
  ...
  function checkMissing() {
    let check = data.demos.map((i, index) => {
      return {
        ...
        options: getOptions(i.code).filter((o) => data.enabledOptions.includes(o.option_id)).length,
    ...
    if (
      missingHeadings.filter((i) => i).filter((i) => i.code !== "DEMO_HOMESET" && i.code !== "DEMO_PRES" && i.code !== "DEMO_LOC")
        .length > 0 ||
      ...
      let notifyMessage =
        ...
        missingHeadings
          .filter((i) => i)
          .filter((i) => i !== "DEMO_HOMESET" && i.code !== "DEMO_PRES" && i.code !== "DEMO_LOC")
          .map((i) => i.heading);
          ...
          <div className="row clearfix">
            <div className="col-12">
              <div className="info-_content">
                ...
                <p>
                  Our platform gives you a powerful voice and your company a way to listen and shape better places for you to
                  work.
                </p>
              </div>
            </div>
              ...
              <div className="col-6 col-md-4 col-xl-2">
                <Tooltip
                  ...
                  title={
                    <p>
                      <strong>Do we need to know about something?</strong>
                      <br /> Provide comments on anything to do with your working environments here.
                    </p>
                  }
                  overlayClassName="responder-home_tooltip"
                >
                  <Link to="/share-thinking" data-tour="my-first-step" className="card rp-home-btn">
            ...
            {client.enable_questions && (
              <div className="col-6 col-md-4 col-xl-2">
                <Tooltip
                  ...
                  title={
                    <p>
                      <strong>We’ll occasionally nudge you to answer a few questions.</strong>
                      <br /> Here is where you can give your responses.
                    </p>
                  }
                  overlayClassName="responder-home_tooltip"
                >
                  <Link to="/answer-question" data-tour="my-second-step" className="card rp-home-btn">
                    <div className="body">
                      <div className="my_sort_cut">
            ...
            {client.enable_xp && (
              <div className="col-6 col-md-4 col-xl-2">
                <Tooltip
                  ...
                  overlayClassName="responder-home_tooltip"
                >
                  <Link to={"/rate-my-xp"} data-tour="my-third-step" className="card rp-home-btn">
                    <div className="body ribbon">
                      <div className="my_sort_cut">
            ...
            <div className="col-6 col-md-4 col-xl-2">
              <Tooltip
                ...
                title={
                  <p>
                    <strong>Learn more about Leesman Inside, read content and view frequently asked questions.</strong>
                  </p>
                }
                overlayClassName="responder-home_tooltip"
              >
                <a href="https://www.leesmaninside.com/" target="_blank" className="card rp-home-btn">
                  <div className="body">
                    <div className="my_sort_cut">
            ...
            <div className="col-12">
              <div className="info-_content gg">
                <p>
                Leesman is committed to protecting your data. When sharing your feedback and personal information, we ensure all responses are kept anonymous.
                </p>
              </div>
            </div>
          </div>
