        ...
        state === 0 && (
          <div className="multi-_step">
            <div className="row clearfix step-_header">
              ...
              <Link to={updateLink ? "/responder-home" : "/"} className="close-_step" title="Close">
              ...
              <div className="row justify-content-center pb-5">
                <div className="col-12 pb-5">
                  <div className="radiobtn">
                    <input onChange={changeBool} type="radio" id={"yes" + index} name="yes-no" value="yes" />
                    <label htmlFor={"yes" + index}>Yes</label>
                  </div>

                  <div className="radiobtn">
                    <input onChange={changeBool} type="radio" id={"no" + index} name="yes-no" value="no" />
      ...
      {state === 2 && (
        <div className="multi-_step">
          ...
          <div className="form-_actions min-h-366">
            ...
            <div className="row justify-content-center pb-5">
              <div className="col-12">
                <input onChange={change} className="checkbox-tools" type="radio" value="-2" name="workplace" id={index + "1"} />
                ...
                <input onChange={change} value="-1" className="checkbox-tools" type="radio" name="workplace" id={index + "2"} />
                ...
                <input onChange={change} className="checkbox-tools" type="radio" name="workplace" value="1" id={index + "4"} />
                ...
                <input onChange={change} className="checkbox-tools" type="radio" name="workplace" value="2" id={index + "5"} />
