        ...
        <div className="form-_actions min-h-366">
          ...
          <div className="row justify-content-center pb-5">
            ...
            <div className="col-12">
              <input onChange={change} value="-2" className="checkbox-tools" type="radio" name="workplace" id={index + "1"} />
              ...
              {!rule.includes("A") && (
                <>
                  <input onChange={change} value="0" className="checkbox-tools" type="radio" name="workplace" id={index + "3"} />
              ...
              <input onChange={change} value="1" className="checkbox-tools" type="radio" name="workplace" id={index + "4"} />
              ...
              <input onChange={change} value="2" className="checkbox-tools" type="radio" name="workplace" id={index + "5"} />
