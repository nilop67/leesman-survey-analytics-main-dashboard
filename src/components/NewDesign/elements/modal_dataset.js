...
const DatasetModal =({setDatasetModal, visibleDatasetModal})=> {
  ...
  return (
    <>
     {/* MODAL */}
     {visibleDatasetModal && <div onClick={()=>setDatasetModal(false)} className="n_modal_bg"></div>}
    <div className={`n_modal ${visibleDatasetModal ? " show" : ""} `}>
      ...
      <div className="n_modal_body">
        ...
        <div className="n_modal_bottom_btns">
          <button onClick={()=>setDatasetModal(false)} className="btn-dash dark float-left">
              Create
          </button>
          <button onClick={()=>setDatasetModal(false)} className="btn-dash outline float-right">
          Cancel
          </button>
        </div>
