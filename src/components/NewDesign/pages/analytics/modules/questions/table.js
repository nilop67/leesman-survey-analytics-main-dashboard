...
const QuestionsTable =({
        ...
        return (
          <div className="action_btns">
              <div className="fixed__btn">
                ...
                <button onClick={()=>setDrawerQuestions(true)} className="icon__btn" title="Edit"><span className="cxv-settings-l-icn clients_table_drop"></span></button>
  ...
  const data = [
    ...
    },
    {
        ...
        type: 'continuous',
        options: ['Bespoke, Tailored', 'Flexible, Responsive', 'Lively, Vibrant',    'Calm, Quiet', 'Contemporary', 'Accessible, Open'],
    },
    {
        key: 'AB003',
