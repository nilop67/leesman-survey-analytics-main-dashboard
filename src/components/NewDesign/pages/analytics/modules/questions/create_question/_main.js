  ...
  return (
    <>
      <div className="col-lg-12">
        ...
        <Popover content={DropdownContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="Dropdown" onChange={() => setQType("Dropdown")} checked={checkedQType === "Dropdown"}/>
        ...
        <Popover content={CheckboxContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="Checkbox" onChange={() => setQType("Checkbox")} checked={checkedQType === "Checkbox"}/>
        ...
        <Popover content={RadioContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="Radio" onChange={() => setQType("Radio")} checked={checkedQType === "Radio"}/>
        ...
        <Popover content={SliderContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="Slider" onChange={() => setQType("Slider")} checked={checkedQType === "Slider"}/>
        ...
        <Popover content={ScaleContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="Scale" onChange={() => setQType("Scale")} checked={checkedQType === "Scale"}/>
        ...
        <Popover content={CustomContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="Custom" onChange={() => setQType("Custom")} checked={checkedQType === "Custom"}/>
        ...
        <Popover content={MainOtherContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="MainOther" onChange={() => setQType("MainOther")} checked={checkedQType === "MainOther"}/>
        ...
        <Popover content={CommentContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="Comment" onChange={() => setQType("Comment")} checked={checkedQType === "Comment"}/>
        ...
        <Popover content={PercentageContent} overlayClassName="maxt">
            <input className="checkbox_qq" type="radio" name="qtype" id="Percentage" onChange={() => setQType("Percentage")} checked={checkedQType === "Percentage"}/>
    ...
    <div className="col-lg-12">
        <div className="n__form_control">
            ...
            <input type="text" name="name" className="n__form_input" style={{minHeight:"35px", maxWidth:"640px"}}/>
            </label>
        </div>
    </div>
