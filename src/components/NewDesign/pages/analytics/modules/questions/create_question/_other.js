    ...
    <>
        ...
        <div className="col-lg-12">
            <Popover content={DropdownAContent} overlayClassName="maxt">
                <div className="n__form_control pr" style={{width:"max-content"}} >
                    ...
                    <span className="label-_text">Set as Additional question</span>
        ...
        <div className="col-lg-12">
            <div className="n__form_control pr">
                <label className="n__form_label dashboard_check">
                <input type="checkbox" name="OtherOnes" value="OtherOnes" onChange={() => setOtherOnes(!isOtherOnes)}/>
                <span className="label-_text">Add an option to disable other selected ones</span>
                <span className="checkmark"></span>
                </label>
            </div>
        </div>
        ...
        <div className="col-lg-12">
            <div className="n__form_control">
                ...
                <input type="text" name="name" className="n__form_input" style={{maxWidth:"640px"}}/>
                </label>
            </div>
        </div>}
        </>
        ...
        <div className="col-lg-12">
            <Popover content={ScaleContentB} overlayClassName="maxt">
                <div className="n__form_control pr" style={{width:"max-content"}} >
                    ...
                    <span className="label-_text">Add 'feature is not provided (X)' column</span>
                    <span className="checkmark"></span>
                    </label>
                </div>
            </Popover>
       ...
       <div className="col-lg-12">
           <div className="n__form_control input_has_btn">
               <label className="n__form_label">
               <div className="group">
                   <input type="text" name="name" className="n__form_input" defaultValue='Columns 1' />
       ...
       <div className="col-lg-12">
           <div className="n__form_control input_has_btn">
               <label className="n__form_label">
               <div className="group">
                   <input type="text" name="name" className="n__form_input" defaultValue='Columns 2' />
                   <button className="iconic__btn" title="Delete"><span className="iconx-minus1"></span></button>
               </div>
               </label>
           </div>
