...
const DrawerDependency =({isDrawerDependency, setDrawerDependency, title})=> {
    ...
    <Drawer
      ...
      >
        <div className="n_drawer_body">
            <button onClick={()=>setDrawerDependency(false)} className="drawer__close"><span className="cxv-close-l-icn"></span></button>
        ...
        <div className="bottom_side">
            <button onClick={()=>setDrawerDependency(false)} className="btn-dash outline float-left tt">
                Cancel
            </button>
            <button onClick={()=>setDrawerDependency(false)} className="btn-dash dark float-right tt">
                Apply
            </button>
        </div>
      </Drawer>
