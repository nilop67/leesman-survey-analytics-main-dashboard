    ...
    <Drawer
      ...
      >
        <div className="n_drawer_body">
            <button onClick={()=>setDrawerAddItems(false)} className="drawer__close"><span className="cxv-close-l-icn"></span></button>
        ...
        <div className="bottom_side">
            <button onClick={()=>setDrawerAddItems(false)} className="btn-dash outline float-left tt">
                Cancel
            </button>
            <button onClick={()=>setDrawerAddItems(false)} className="btn-dash dark float-right tt">
                Apply
            </button>
        </div>
      </Drawer>
