  ...
  return (
    ...
    <div className="top__filter-dashboard b-t-b">
        ...
        <div className="left__side">
            ...
            <>
            <div className="left__item">
                <button className="btn-dash drop has-icn" onClick={()=>setDrawerSections(true)}>
                Add new section
            ...
            <>
            <div className="left__item">
                <button className="btn-dash drop has-icn" onClick={()=>setDrawerPages(true)}>
                Add new page
                    <span className="cxv-create-l-icn"></span>
                </button>
            </div>
            ...
            <>
            <div className="left__item">
                <button className="btn-dash drop has-icn" onClick={()=>setDrawerQuestions(true)}>
                Add new question
                    <span className="cxv-create-l-icn"></span>
                </button>
            </div>
            ...
            <>
            <div className="left__item">
                <button className="btn-dash drop has-icn" onClick={()=>setDrawerDependency(true)}>
                Add new dependency
                    <span className="cxv-create-l-icn"></span>
                </button>
            </div>
