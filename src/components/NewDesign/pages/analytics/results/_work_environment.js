...
const WorkEnvironment =()=> {
  ...
  //   Custom ANT Filter
    ...
    const columns = [
      {
        ...
        width:"28.65%",
        render: (text, row, index) => <HeatMapLabel value={text} row={row} index={index} isItemNumber={3}/>,
      },
      {
      ...
      },
      {
        ...
        width:"100px",
        className: "classNameOfBold",
        render: (text, name) => <span className={`items_result`}>{text === null ? "-" : text}</span>,
      },
      {
      ...
      {
        title: <div className="dark__title xs">Comparison<br/>dataset 1<br/>distribution</div>,
        dataIndex: 'cDistribution',
        key: 'cDistribution',
        className: "classNameOfBold",
        render: (text, name) => <span className={`items_result`}>
                                          {text === null ? "-" : text+"%"}
                                </span>,
      },
      {
        title: <div className="dark__title xs">Comparison<br/>dataset 1<br/>LMI</div>,
        dataIndex: 'lDistribution',
        key: 'lDistribution',
        className: "classNameOfBold",
      },
      {
        title: <div className="dark__title xs">Comparison<br/>dataset 2<br/>distribution</div>,
      ...
      {
        title: <div className="dark__title xs">Comparison<br/>dataset 2<br/>LMI</div>,
    ...
    const columns2 = [
      ...
      {
        title: <div className="demographics__title">
                  <ul>
                    <li><span className="marker blue-light"></span>Yes it’s permanently assigned</li>
                  </ul>
                </div>,
      ...
      },
      {
        ...
        key: 'lmi',
        width:"100px",
        render: (text, name) => <span className={`items_result green`}>{text === null ? "-" : text}</span>,
      },
      {
        ...
        render: (value, row, index) => {
          ...
          if (index >= 1 && value === data2[index - 1].lmiRange) {
            ...
            for (
              let i = 0;
              index + i !== data2.length &&
              value === data2[index + i].lmiRange;
              i += 1
            ) {
              obj.props.rowSpan = i + 1;
            }
      ...
      },
      {
        title: <div className="demographics__title">
                  <ul className='d-block'>
                    <li><span className="marker blue-dark"></span>No, I book in advance</li>
                    <li><span className="marker blue-light"></span>No, I use it when it’s unoccupied (without booking)</li>
                  </ul>
                </div>,
        dataIndex: 'demographics',
        key: 'demographics',
      ...
      },
      {
        ...
        render: (value, row, index) => {
          ...
          if (index >= 1 && value === data3[index - 1].lmiRange) {
            ...
            for (
              let i = 0;
              index + i !== data3.length &&
              value === data3[index + i].lmiRange;
              i += 1
            ) {
              obj.props.rowSpan = i + 1;
            }
  ...
  return (
    ...
    <div className="col-lg-12">
        <h2 className="table_question_title">Q — Think about your organisation’s workplace. How often do you work there?</h2>
    ...
    <div className="col-lg-12">
        <h2 className="table_question_title">Q — What type of setting is it?</h2>
