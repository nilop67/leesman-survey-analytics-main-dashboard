...
const SentimentBreakdown =()=> {
  ...
  //   Custom ANT Filter
    ...
    const columns = [
      {
        title: <div className="dark__title">Super<br/>driver</div>,
      ...
      },
      {
        ...
        key: 'nullArea',
        width:"300px",
        render: (text) => <><span className="bold_it">{text.split(" ")[0]}</span> {text.substr(text.indexOf(" ") + 1)}</>
      },
      {
      ...
      {
        title: <div className="dark__title">Importance<br/>%</div>,
      ...
      },
      {
        ...
        render: (text) => <div className={`sup_result 
                                            ${text <= 16 ? "red" : " "} 
                                            ${text > 16 && text <= 32 ? "orange" : " "} 
                                            ${text > 32 && text <= 48 ? "yellow" : " "} 
                                            ${text > 48 && text <= 64 ? "green-light" : " "} 
                                            ${text > 64 && text <= 80 ? "green" : " "} 
                                            ${text > 80 ? "green" : " "} 
                                          `}>{text}%</div>
      },
    ];
                      ...
                      <tr>
                        ...
                        <td className="ant-table-cell pos_r">
                          ...
                          <div className="table_chart_legend stacked bd">
                              <ul>
                                <li><span className="marker ss1"></span>Not supported</li>
                                <li><span className="marker ss2"></span>Very under supported</li>
                                <li><span className="marker ss3"></span>Under supported</li>
                                <li><span className="marker ss4"></span>Supported</li>
                                <li><span className="marker ss5"></span>Well supported</li>
                                <li><span className="marker ss6"></span>Very well supported</li>
                              </ul>
                        </div>
                        </td>
                        <td className="ant-table-cell"></td>
