    ...
    const columns = [
      ...
      },
      {
        title: <div className="demographics__title">
                  <ul>
                    <li><span className="marker blue-light"></span>Not working from home</li>
                    <li><span className="marker blue-dark"></span>Working from home</li>
                  </ul>
                </div>,
      ...
      {
        title: <div className="muted__title">Benchmark<br/>Lmi</div>,
      ...
      {
        title: <div className="dark__title">Respondents<br/>working<br/>from home</div>,
      ...
      },
      {
        ...
        key: 'hLmi',
        width:"100px",
        render: (text, name) => <span className={`items_result red`}>{text === null ? "-" : text}</span>,
      },
      {
      ...
      {
        title: <div className="muted__title">Benchmark<br/>H-Lmi</div>,
