    ...
    <div className="col-lg-12">
        <div className="n_table has__pre has_first_one_column has_multi_table center_labels custom">
            ...
            <div className="table_chart_legend gr">
                  <h3>% Supported</h3>
                  <ul>
                    <li><span className="marker red"></span> Below Leesman Benchmark</li>
                    <li><span className="marker green"></span> Above Leesman Benchmark</li>
                    <li><span className="marker muted"></span> Same as Leesman Benchmark</li>
                  </ul>
            </div>
        </div>
    </div>
