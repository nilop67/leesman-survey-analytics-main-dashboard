...
const HeatmapTableBlueDark =()=> {
  ...
  //   Custom ANT Filter
    ...
    const columns = [
      ...
      {
        title: <div className="dark__title">Accounting<br/>and Finance</div>,
      ...
      {
        title: <div className="dark__title">Group<br/>Strategy</div>,
        dataIndex: 'strategy',
        key: 'strategy',
      ...
      {
        title: <div className="dark__title">Human<br/>Resources</div>,
        dataIndex: 'resources',
        key: 'resources',
      ...
      {
        title: <div className="dark__title">Information<br/>Technology</div>,
      ...
      {
        title: <div className="dark__title">Research and<br/>Development</div>,
      ...
      {
        title: <div className="muted__title">Office<br/>Benchmark</div>,
        dataIndex: 'benchmark',
        key: 'benchmark',
        width:"100px",
        render: (text, name) => <span className={`items_result`}>{text === null ? "-" : text}</span>,
    ...
    const columns2 = [
      {
        ...
        key: 'superDriver',
        width:50,
        render: (text) => <span className={`${text ? "cxc-super-driver-new icon-table-status" : ""} `}></span>,
      },
      {
        title: <div className="null__title"></div>,
        dataIndex: 'nullSection',
          ...
          <div className="n_table has__pre has_first_one_column has_multi_table center_labels custom">
              ...
              <Table 
                  ...
                  <div className="table_chart_legend bd">
                        <h3>% Importance</h3>
                        <ul>
                          <li><span className="marker aa1"></span> 0% – 20%</li>
                          <li><span className="marker aa2"></span> 21% – 40%</li>
                          <li><span className="marker aa3"></span> 41% – 60%</li>
                          <li><span className="marker aa4"></span> 61% – 80%</li>
                          <li><span className="marker aa5"></span> 81% – 100%</li>
                        </ul>
                  </div>
          </div>
      </div>
