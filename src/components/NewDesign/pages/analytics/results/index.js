        ...
        */}
        <TopActions 
                ...
                isInternalComparison={
                    isSelectChartType === 6 ||
                    isSelectChartType === 7 ||
                    isSelectChartType === 9 ? true : false
                }
                ...
                isQuestionSet={
                    ...
                    isSelectChartType === 4 || 
                    isSelectChartType === 6 ||
                    isSelectChartType === 7 ? true : false
                }
                isOrderBy={
					isSelectChartType === 0 ||
					isSelectChartType === 1 || 
                ...
                isMinimumRespondents={
                    isSelectChartType === 6 ||
                    isSelectChartType === 7 ||
                    isSelectChartType === 10 ? true : false
                }
                ...
                isLmiHlmi={
                    isSelectChartType === 2 ||
                    isSelectChartType === 3 ||
                    isSelectChartType === 11 ? true : false
                }
                isMeasue={
                    isSelectChartType === 4 || 
                    isSelectChartType === 6 ||
                ...
                isGap={
                    isSelectChartType === 4 ? true : false
                }
                isColourCoding={
                    isSelectChartType === 6 ||
                    isSelectChartType === 7 ? true : false
                ...
                isAxis={
                    isSelectChartType === 1 ? true : false
                }
