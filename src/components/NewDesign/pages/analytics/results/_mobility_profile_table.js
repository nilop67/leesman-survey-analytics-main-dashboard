...
const MobilityProfile =()=> {
  ...
  //   Custom ANT Filter
    ...
    const columns = [
      {
        ...
        width:"300px",
        render: (text, row, index) => <HeatMapLabel value={text} row={row} index={index} isItemNumber={4}/>,
      },
      {
      ...
      },
      {
        ...
        className: "classNameOfBold",
        render: (text, name) => <span className={`items_result 
                                    ${text !== 71.1 && text < 64 ? " red" : text !== 71.1 && text >= 64 ? " green" : "blue"}
                                    `}
                                    >
      ...
      {
        title: <div className="muted__title xs">Benchmark<br/>distribution</div>,
      ...
      {
        title: <div className="muted__title xs">Benchmark<br/>Lmi</div>,
        dataIndex: 'bLmi',
        key: 'bLmi',
        className: "classNameOfBold",
      },
    ...
    const data = [
      ...
      {
        key: '1AB002',
        nullSection: 'I primarily work there but attend meetings off-site or work elsewhere',
        respondents: 771,
        distribution: 35,
        lmi: 64.4,
        lmiRange: 8.7,
    ...
    const data2 = [
      ...
      {
        key: '2AB004',
        nullSection: 'I rarely work at a single setting, but mainly use multiple settings',
        respondents: 205,
        distribution: 9,
        lmi: 61.1,
        lmiRange: 8.7,
  ...
  return (
    ...
    <div className="col-lg-12">
        <h2 className="table_question_title">Q — Thinking about how you use your workplace, which of the following most closely describes your work mobility?</h2>
        <div className="n_table height60 has__pre  center_labels first_not_center  has_chart with_multi">
            <div className="n_donut_chart">
              <div className="height__40">
