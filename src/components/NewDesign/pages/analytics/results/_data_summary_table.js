    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, name) => <span className={`items_result 
                                          ${name.name === "Lmi experience score" && text === 66.2 ? " green" : ""}
                                          ${name.name === "Lmi experience score" && text === 64.1 ? " green" : ""}
                                          ${name.name === "Lmi experience score" && text === 74.7 ? " blue" : ""}
                                          ${name.name === "H-Lmi experience score" && text === 71.6 ? " red" : ""}
                                          `}
                                          >

                                            {text === null ? "-" : text}{name.name === "Response rate" && text !== null ? "%" : ""}
                                </span>,
      },
      {
        title: <div className="dark__title">Leesman Office Benchmark (Q1 2022)</div>,
