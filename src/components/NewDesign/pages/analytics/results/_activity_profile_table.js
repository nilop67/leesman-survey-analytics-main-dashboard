...
const ActivityProfile =()=> {
  ...
  //   Custom ANT Filter
    ...
    const columns = [
      {
        title: <div className="dark__title xs text-left">Activity complexity</div>,
      ...
      {
        title: <div className="dark__title xs">Respondents<br/>working from<br/>home </div>,
        dataIndex: 'rwfh',
        key: 'rwfh',
        className: "classNameOfBold",
      },
      ...
      {
        title: <div className="muted__title xs">Benchmark<br/>H-Lmi</div>,
        dataIndex: 'bHLmi',
        key: 'bHLmi',
        className: "classNameOfBold",
        render: (text, name) => <span className={`items_result`}>
    ...
    const columns2 = [
      {
        ...
        className: "classNameOfBold",
        width:"300px",
        render: (text, row, index) => <HeatMapLabel value={text} row={row} index={index} isItemNumber={5}/>,
      },
      {
        title: <div className="dark__title xs">Respondents</div>,
        dataIndex: 'respondents',
