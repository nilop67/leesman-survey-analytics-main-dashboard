    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, name) => <span className={`items_result 
                                    ${name.name === "Lmi" && text === 71.1 ? " blue" : ""}
                                    ${name.name === "Lmi" && text !== 71.1 && text < 64 ? " red" : ""}
                                    ${name.name === "Lmi" && text !== 71.1 && text >= 64 ? " green" : ""}
                                    ${name.name === "H-Lmi" && text < 74 ? " red" : ""}
                                    ${name.name === "H-Lmi" && text >= 74 ? " green" : ""}
                                    `}
                                    >
