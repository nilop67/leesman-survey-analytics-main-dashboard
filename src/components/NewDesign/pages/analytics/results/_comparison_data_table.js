...
const ComparisonDataTable =()=> {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            width:100,
            render: (text) => <span className={`items_result 
                                              ${text < 33 ? " red" : ""} 
                                              ${text >= 33 && text < 66 ? " black" : ""} 
                                              ${text >= 66 ? " green" : ""} 
                                              `}>{text}%</span>,
          }
        ]
  ...
  return (
    ...
    <div className="col-lg-12">
        <h2 className="table_question_title">Q — Thinking about the work that you do, which of the following activities are important and how well are they supported?</h2>
