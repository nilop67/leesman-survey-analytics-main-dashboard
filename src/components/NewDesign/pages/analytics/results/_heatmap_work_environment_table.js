...
const HeatmapTableRadial =()=> {
  ...
  //   Custom ANT Filter
    ...
    const columns = [
      {
        ...
        width:"300px",
        render: (text, row, index) => <HeatMapLabel value={text} row={row} index={index} isItemNumber={6}/>,
      },
    ];
    ...
    const data = [
      ...
      {
        key: 'AB003',
        nullSection: 'Other workplaces (e.g.) those of clients, partners or suppliers)',
        color: "light-blue",
      },
      {
        key: 'AB004',
  ...
  return (
    ...
    <div className="col-lg-12">
        <h2 className="table_question_title">Q — On average, what proportion of your time at your organisation do spend at the following locations?</h2>
