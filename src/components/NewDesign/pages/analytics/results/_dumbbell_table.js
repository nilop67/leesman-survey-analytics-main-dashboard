...
const DumbbellTable =()=> {
  ...
  //   Custom ANT Filter
    ...
    const columns = [
      ...
      {
        title: <div className="dark__title">Comparison<br/>set 1 % gap -<br/>support</div>,
      ...
      {
        title: <div className="dark__title">Comparison<br/>set 2 % gap -<br/>support</div>,
                        ...
                        <tr>
                          ...
                          <td className="ant-table-cell pos_r">
                            ...
                            <div className="table_chart_legend db">
                                  <ul>
                                    <li><span className="marker dd1"></span>Dataset X</li>
                                    <li><span className="marker dd2"></span>Comparison dataset 1</li>
                                    <li><span className="marker dd3"></span>Comparison dataset 2</li>
                                  </ul>
                            </div>
                          </td>
                          <td className="ant-table-cell"></td>
