...
const Overview = () => {
    ...
    const range_data = [
        { id: 1, label: "L+ 86.2", label_color: "blue", bar_height: 86.2, bar_bottom: 0, bar_color: "dark_blue", legend_label: "Antwerpen Centraal Stationsgebouw", legend_color: "dark_blue" },
        { id: 2, label: "55.6", label_color: "red", bar_height: 55.6, bar_bottom: 0, bar_color: "light_blue", legend_label: "Antwerpen Century Center Offices", legend_color: "light_blue" },
        { id: 3, label: "30.6", label_color: "black", bar_height: 30.6, bar_bottom: 55.6, bar_color: "black", legend_label: "Difference", legend_color: "black" },
    ];

    const bar_data = [
        { id: 1, label: "Assigned work setting", bar_width: 75, legend_label: "Lmi", legend_color: "red", legend_value: 58.2 },
        { id: 2, label: "Flexible work setting", bar_width: 23, legend_label: "Lmi", legend_color: "red", legend_value: 70.7 },
        { id: 3, label: "Specialist practical/technical setting", bar_width: 2, legend_label: "Lmi", legend_color: "red", legend_value: 67.1 },
        { id: 4, label: "Other", bar_width: 1, legend_label: "Lmi", legend_color: "red", legend_value: 57.7 },
    ];

    const activity_data = [
        { id: 1, left_color: "dark_blue", activity_value: 17, activity_label: "Up to 5", no: 388, lmi: 65.5, lmi_color: "green", hlmi: 65.1, hlmi_color: "red" },
        { id: 2, left_color: "light_blue", activity_value: 44, activity_label: "6 to 10", no: 153, lmi: 68.4, lmi_color: "green", hlmi: 65.9, hlmi_color: "red" },
        { id: 3, left_color: "grey", activity_value: 24, activity_label: "11 to 15", no: 212, lmi: 65.2, lmi_color: "green", hlmi: 65.6, hlmi_color: "red" },
        { id: 4, left_color: "blue", activity_value: 15, activity_label: "16 to 21", no: 135, lmi: 61.5, lmi_color: "red", hlmi: 64.5, hlmi_color: "red" },
    ];
    ...
    return (
        <>
            <LoaderPage />
            <LeftFilter visibleDrawer={visibleLeftDrawer} setVisibleDrawer={setVisibleLeftDrawer} setDatasetModal={setDatasetModal} />
            <RightFilter visibleDrawer={visibleRightDrawer} setVisibleDrawer={setVisibleRightDrawer} />

            <DatasetModal visibleDatasetModal={visibleDatasetModal} setDatasetModal={setDatasetModal} />
            <DatasetModalLarge visibleDatasetModal={visibleDatasetModalLarge} setDatasetModal={setDatasetModalLarge} />
                    ...
                    <div className="col-lg-12 top_filters">
                        <div className="top_filters_container">
                            {data_filters40.map((item, i, arr) => (
                                <DashboardKeySelect item={item} i={i} arr={arr} bordered={true} />
                            ))}
                        </div>
                    </div>
                                ...
                                <div className="n_card">
                                    <div className="n-body min__height405">
                                        ...
                                        {data_filters41.map((item, i, arr) => (
                                            <CustomSelect item={item} i={i} arr={arr} bordered={false} />
                                        ))}
                                        <div className="row">
                            ...
                            <div className="col-lg-12">
                                <div className="n_card">
                                    <div className="n-body min__height405">
                                        ...
                                        <span className="card_desc">My workplace/home environment enables me to work productively.</span>
                                        <div className="row">
                                            <div className="col-lg-12">
                            ...
                            <div className="col-lg-12">
                                <div className="n_card">
                                    <div className="n-body min__height405">
                                        ...
                                        <span className="card_desc">I am able to share ideas/knowledge amongst colleagues.</span>
                                        <div className="row">
                                            <div className="col-lg-12">
                                                <div className="n_radial_chart">
                                                    <RadialBar />
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li className="results">
                                                            ...
                                                            <div className="results_info">
                                                                <div className="left">
                                                                    <span>88.4 <span className="perc">%</span></span>
                                                                    <span className="cxv-above-benchmark-l-icn green icon"></span>
                                                                </div>
                                                                <div className="right">
                                                                    <span>38.7 <span className="perc">%</span></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li className="results">
                                                            ...
                                                            <div className="results_info">
                                                                <div className="left">
                                                                    <span>87.6 <span className="perc">%</span></span>
                                                                    <span className="cxv-above-benchmark-l-icn green icon"></span>
                                                                </div>
                                                                <div className="right">
                                                                    <span>76.9 <span className="perc">%</span></span>
                                                                </div>
                                                            </div>
                                                        </li>

                                                        <li className="results">
                                                            <h5>Informal social interaction <span className="cxv-top-tip-l-icn"></span></h5>
                                                            <div className="results_info">
                                                                <div className="left">
                                                                    <span>83.7 <span className="perc">%</span></span>
                                                                    <span className="cxv-equal-to-benchmark-l-icn dark icon"></span>
                                                                </div>
                                                                <div className="right">
                                                                    <span>57.4 <span className="perc">%</span></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div className="col-lg-6">
                                                <div className="blocks__area">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li className="results">
                                                            <h5>Thinking/creative thinking <span className="cxc-super-driver-new"></span></h5>
                                                            <div className="results_info">
                                                                <div className="left">
                                                                    <span>47.6 <span className="perc">%</span></span>
                                                                    <span className="cxv-below-benchmark-l-icn red icon"></span>
                                                                </div>
                                                                <div className="right">
                                                                    <span>44.5 <span className="perc">%</span></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li className="results">
                                                            ...
                                                            <div className="results_info">
                                                                <div className="left">
                                                                    <span>56.7 <span className="perc">%</span></span>
                                                                    <span className="cxv-below-benchmark-l-icn red icon"></span>
                                                                </div>
                                                                <div className="right">
                                                                    <span>30.2 <span className="perc">%</span></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li className="results">
                                                            ...
                                                            <div className="results_info">
                                                                ...
                                                                <div className="right">
                                                                    <span>57.1 <span className="perc">%</span></span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div className="col-lg-6">
                                                <div className="blocks__area">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li className="results">
                                                            <h5>Desk <span className="cxc-super-driver-new"></span></h5>
                                                            <div className="results_info">
                                                                <div className="left">
                                                                    <span>90.5</span>
                                                                ...
                                                                <div className="right">
                                                                    <span>86.5 <span className="perc">%</span></span>
                                                        ...
                                                        <li className="results">
                                                            <h5>Using technical/specialist equipment or materials </h5>
                                                            <div className="results_info">
                                                                <div className="left">
                                                                    <span>87.4</span>
                                                                    <span className="cxv-above-benchmark-l-icn green icon"></span>
                                                                ...
                                                                <div className="right">
                                                                    <span>75.3 <span className="perc">%</span></span>
                                                                    {/* <span className="percentage">%</span> */}
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li className="results">
                                                            ...
                                                            <div className="results_info">
                                                                ...
                                                                <div className="right">
                                                                    <span>72.0 <span className="perc">%</span></span>
                                                                    {/* <span className="percentage">%</span> */}
                                                                </div>
                                                            </div>
                                                        </li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li className="results">
                                                            ...
                                                            <div className="results_info">
                                                                ...
                                                                <div className="right">
                                                                    <span>31.9 <span className="perc">%</span></span>
                                                                    {/* <span className="percentage">%</span> */}
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li className="results">
                                                            <h5>Space for working with car parts/test equipment (experience)</h5>
                                                            <div className="results_info">
                                                                <div className="left">
                                                                    <span>26.5</span>
                                                                    <span className="cxv-below-benchmark-l-icn red icon"></span>
                                                                ...
                                                                <div className="right">
                                                                    <span>26.5 <span className="perc">%</span></span>
                                                                    {/* <span className="percentage">%</span> */}
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li className="results">
                                                            ...
                                                            <div className="results_info">
                                                                ...
                                                                <div className="right">
                                                                    <span>40.2 <span className="perc">%</span></span>
                                                                    {/* <span className="percentage">%</span> */}
                                                                </div>
                                                            </div>
                                                        </li>
