        ...
        <div className="left__side">
            ...
            <div className="left__item">
                <div className="n__form_control top_action_check">
                    ...
                    <input type="checkbox" name="oldUserData" value="oldUserData" />
            ...
            <>
            <div className="left__item">
                <button onClick={()=>setDemographicsQuestionsDrawer(true)} className="btn-dash drop has-icn">
                Add new question
            ...
            <>
            <div className="left__item">
                <button onClick={()=>setTailorLocationDrawer(true)} className="btn-dash drop has-icn">
            ...
            <div className="h_divider qq"></div>
            <div className="left__item">
                <button onClick={()=>setLocationGroupDrawer(true)} className="btn-dash drop has-icn">
                Select locations
                    <span className="cxv-create-l-icn"></span>
                </button>
            </div>
            ...
            <div className="left__item">
                <div className="n__form_control top_action_check">
                    <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="asLocationGroup" value="asLocationGroup" />
                    <span className="label-_text">Use 'Other' as location group</span>
                    <span className="checkmark"></span>
                    </label>
                </div>
            </div>
            ...
            <div className="left__item">
                <div className="n__form_control top_action_check">
                    <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="asLocation" value="asLocation" />
            ...
            <>
            <div className="left__item">
                <button onClick={()=>setDepartmentSurveyDrawer(true)} className="btn-dash drop has-icn">
                    Select departments
                    <span className="cxv-create-l-icn"></span>
                </button>
            </div>
            ...
            <div className="left__item">
                <div className="n__form_control top_action_check">
                    <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="asDepartment" value="asDepartment" />
                    <span className="label-_text">Use 'Other' as department</span>
                    <span className="checkmark"></span>
                    </label>
                </div>
            </div>
            ...
            <div className="left__item">
                <div className="n__form_control input_has_btn">
                    ...
                    <div className="group">
                        <input type="email" name="name" className="n_input" placeholder='Email...' />
            ...
            <>
            <div className="left__item">
                <button onClick={()=>setModulesDrawer(true)} className="btn-dash drop has-icn">
