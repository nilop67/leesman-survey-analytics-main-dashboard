...
const DrawerDepartmentSurvey =({isDepartmentSurveyDrawer, setDepartmentSurveyDrawer, title})=> {

  const [expandedKeys, setExpandedKeys] = useState(['Department 0-0-0', 'Department 0-0-1']);
  ...
  return (
    ...
    <Drawer
        ...
        extra={
          <Space>
            <Button onClick={()=>setDepartmentSurveyDrawer(false)}>Cancel</Button>
            <Button type="primary" onClick={()=>setDepartmentSurveyDrawer(false)}>
              OK
            </Button>
          </Space>
        }
      >
        <div className="n_drawer_body">
            <button onClick={()=>setDepartmentSurveyDrawer(false)} className="drawer__close"><span className="cxv-close-l-icn"></span></button>
        ...
        <div className="bottom_side">
            <button onClick={()=>setDepartmentSurveyDrawer(false)} className="btn-dash outline float-left tt">
                Cancel
            </button>
            <button onClick={()=>setDepartmentSurveyDrawer(false)} className="btn-dash dark float-right tt">
                Apply
            </button>
        </div>
      </Drawer>
