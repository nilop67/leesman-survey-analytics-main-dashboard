...
const data = [
 {
    ...
    {
      key: 'AAB002',
      module: 'Leesman Alignment Module',
      index: 1,
    },
    {
      key: 'AAB003',
      module: 'Leesman 3rd Space Module',
      index: 2,
    },
];
              ...
              <div className="fixed__btn">
                    <div className="n__form_control">
                        <label className="n__form_label dashboard_radio">
                            <input type="radio" name="modules" value="select"  defaultChecked={record.module === "Office"}/>
