          ...
          return (
            <div className="action_btns">
                <div className={`drop__btn ${action ? " show" : ""} `}>
                  <button className="icon__btn" onClick={action ? () => setActionKey('') : () => openDrop(record)}><span ref={ref_custom_table_drop} className="cxv-action-l-icn custom_table_drop"></span></button>
                  <div className="drop__menu">
                      <ul>
                          <li><button>Edit</button></li>
                          <li><button>Create new surveys</button></li>
                ...
                <div className="top__filter-dashboard b-t-b">
                        ...
                        <div className="left__item">
                          <div className="labeled_custom_select default">
                            <label className="dashboard_radio">
                                <input type="radio" name="dd1" value="FilterGroups" checked={topSelect === "FilterGroups" ? "checked" : ""} onChange={()=>setTopSelect("FilterGroups")}/>
                                <span className="label-_text">Filter groups</span>
                                <span className="checkmark"></span>
                            </label>
                          </div>
                        </div>
                        <div className={`left__item ${topSelect === "FilterGroups" ? " " : " closed"}`}>
                          <DropMenuRadio data={data_filters_4} setTopSelectFlag={setTopSelectFlag} isTopSelectFlag={isTopSelectFlag}/>
                        </div>
                        <div className="h_divider qq"></div>
                        <div className="left__item">
                          <div className="labeled_custom_select default">
                            <label className="dashboard_radio">
                                <input type="radio" name="dd1" value="Datasets" checked={topSelect === "Datasets" ? "checked" : ""} onChange={()=>setTopSelect("Datasets")}/>
                                <span className="label-_text">Datasets</span>
                                <span className="checkmark"></span>
                            </label>
                          </div>
                        </div>
                        <div className={`left__item ${topSelect === "Datasets" ? " " : " closed"}`}>
                          <DropMenuRadio data={data_filters} setTopSelectFlag={setTopSelectFlag} isTopSelectFlag={isTopSelectFlag}/>
                        </div>
                        <div className="h_divider qq"></div>
                        <div className="left__item">
                    ...
                    <div className="right__side">
                        <div className="right__item">
                            <button onClick={()=>setDatasetModalLarge(true)} className="btn-dash drop has-icn">
                                Create new
