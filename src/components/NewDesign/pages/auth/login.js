          ...
          <div className="col-lg-12">
            <div className="n_auth__section">
              <div className="n_auth__container">
                ...
                <img className="auth_hero_img" src="/assets/images/svg-images/leesman_analytics.svg"></img>

                <h1>Login ― </h1>
                <p className="auth_desc">If you are a current Leesman client and already have access to Leesman’s Analytics engine, please use the access logins granted to you.</p>

                <p className="auth_desc">If you are a new user and would like to register for a trial account to see the benefits of the Leesman Index free of charge, please register here.*</p>

                <div className="n_auth_form">
                  {commonAuthItem(change, formData, "email", handleLogin, "Email")}
                  {commonAuthItem(change, formData, "password", handleLogin, "Password")}

                  {/* <input placeholder="Email" type="text" className="n_input"></input>
                  <input placeholder="Password" type="text" className="n_input"></input> */}

                  <Link to="/reset-password" className="n__link">Forgotten Password?</Link>

                  <button className="btn-dash dark" onClick={handleLogin} disabled={loginSpinner === "spin"}>
                    {loginSpinner === "spin" ? <div className="sbl-circ"></div> : "Login"}
                  </button>
                </div>

                <p className="n_terms">*Access to the Leesman Analytics is by permission only. In accessing this site, you agree to be bound by our <a href="#!">Web Terms & Conditions</a>. All client information accessed should be treated as Privileged and Strictly Confidential.</p>
