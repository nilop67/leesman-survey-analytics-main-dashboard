          ...
          <div className="col-lg-12">
            <div className="n_auth__section">
              <div className="n_auth__container">
                ...
                <p className="auth_desc">If you forgot your password, well, then we’ll email you instructions to reset your password.</p>

                <div className="n_auth_form">
                  {commonAuthItem(change, formData, "email", changePassword)}

                  <Link to="/login" className="n__link">Return to login</Link>
