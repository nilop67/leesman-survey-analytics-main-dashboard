          ...
          return (
            <div className="action_btns">
                <div className={`drop__btn ${action ? " show" : ""} `}>
                  <button className="icon__btn" onClick={action ? () => setActionKey('') : () => openDrop(record)}><span ref={ref_campaigns_table_drop} className="cxv-action-l-icn campaigns_table_drop"></span></button>
                  <div className="drop__menu">
                      <ul>
                          <li><Link to="/create-campaigns">Edit</Link></li>
                          <li><Link to="/create-campaigns">Create new campaign</Link></li>
                          <li><button>View in build campaign</button></li>
