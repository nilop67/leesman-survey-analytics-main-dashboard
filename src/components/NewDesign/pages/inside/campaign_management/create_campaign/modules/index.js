...
const CModulesSettings = () => {
  const workItems = ["Planned meetings","Individual focused work away from your desk","Reading","Collaborating on focused work","Learning from others","Informal, un-planned meetings","Individual routine tasks"];
        ...
        <div className="n__body">
          ...
          <div className="row">
            ...
            <div className="col-lg-2">
              <div className="n__form_control">
                <label className="n__form_label dashboard_check">
                  <input type="checkbox" name="Collaboration" value="Collaboration"/>
