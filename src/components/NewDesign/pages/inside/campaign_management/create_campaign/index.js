              ...
              <div className="left__side">
                <div className="left__item">
                  <div className="n_menu_horizontal top">
                      ...
                      <a onClick={()=>{setMenu("General");setMenuSub("")}} href="#!" className={`${isMenu === "General" ? " active" : ""} `}>General</a>
                      <a onClick={()=>{setMenu("Campaign modules");setMenuSub("")}} href="#!" className={`${isMenu === "Campaign modules" ? " active" : ""} `}>Campaign modules</a>
                      <a onClick={()=>{setMenu("Demographics");setMenuSub("")}} href="#!" className={`${isMenu === "Demographics" ? " active" : ""} `}>Demographics</a>
                      <a onClick={()=>{setMenu("Target");setMenuSub("")}} href="#!" className={`${isMenu === "Target" ? " active" : ""} `}>Target responders</a>
                    </div>
                </div>
              </div>
