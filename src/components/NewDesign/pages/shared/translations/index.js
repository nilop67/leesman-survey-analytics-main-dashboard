      ...
      <div className="container-fluid">
        ...
        <div className="row clearfix">
              ...
              <div className="left__side">
                <div className="left__item">
                  <div className="n_menu_horizontal top">
                      <a onClick={()=>{setMenu("Pages");setMenuSub("")}} href="#!" className={`${isMenu === "Pages" ? " active" : ""} `}>Pages</a>
                      <a onClick={()=>{setMenu("Questions");setMenuSub("")}} href="#!" className={`${isMenu === "Questions" ? " active" : ""} `}>Questions</a>
                      <a onClick={()=>{setMenu("Options");setMenuSub("")}} href="#!" className={`${isMenu === "Options" ? " active" : ""} `}>Options</a>
                      <a onClick={()=>{setMenu("Survey UI");setMenuSub("")}} href="#!" className={`${isMenu === "Survey UI" ? " active" : ""} `}>Survey UI</a>
                    </div>
                </div>
              </div>
          ...
          <div className="col-lg-12 mt-3">
            <TopTranslationsActions
              isMenu={isMenu}
              isMenuSub={isMenuSub}
            />
          </div>

          <div className={`${isMenu === "Survey" ? "col-lg-12" : "col-lg-12"} `}>
