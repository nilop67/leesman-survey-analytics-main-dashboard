            ...
            <>
              <ul className="translations_tags">
                {translations.map(tag => {
                  return (
                      <li className="table__type">{tag}</li>
                  );
                })}
              </ul>
            </>
          ...
          render: (_, record) => {
            return (
              <div className="action_btns">
                  <button className="btn-dash-export" onClick={()=>setDrawerEditTranslation(true)} >
      ...
      const data = [
        {
          ...
          translations: ['English (UK)', 'Chinese (Hong Kong)', 'Czech', 'Danish', 'Dutch', 'Greek'],
  ...
  return (
    ...
    <div className="n__card hast__table mt-0">
      <div className="n__body">
        ...
        {isMenu !== "Survey UI" ? <span className="card_desc">Total: <strong>11 {isMenu}</strong></span> : <></>}
                    ...
                    <Table 
                        ...
                        expandable={{
                          expandedRowRender: (record) => (
                            <ul className="locations" style={{padding: "15px", marginLeft: "40px"}}>
