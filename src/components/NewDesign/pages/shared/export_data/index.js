              ...
              <div className="left__side">
                ...
                <div className="clickable_list">
                  <ul>
                      ...
                      <li className="">
                          <span>Location and department breakdowns (location-demographics)</span>
                          <button className="btn-dash-export">
                              <span className="cxv-export-l-icn"></span>
                          </button>
                      </li>
                      <li className="">
                          <span>Demographics breakdown by department (demographics-department)</span>
                          <button className="btn-dash-export">
                              <span className="cxv-export-l-icn"></span>
                          </button>
                      </li>
                      <li className="">
                          <span>Demographics breakdown by location (demographics-location)</span>
                          <button className="btn-dash-export">
                              <span className="cxv-export-l-icn"></span>
                          </button>
                      </li>
