...
const DrawerImportExport =({isImportExportDrawer, setImportExportDrawer, title})=> {
    ...
    <Drawer
      ...
      >
        <div className="n_drawer_body">
            <button onClick={()=>setImportExportDrawer(false)} className="drawer__close"><span className="cxv-close-l-icn"></span></button>
                ...
                <div className="col-lg-12">
                        <div className="fixed_infos mb-2">
                            <span className="card_desc info">
                                <strong><span className="iconx-info-with-circle"></span> Only CSV, XLSX file types</strong>
        ...
        <div className="bottom_side">
            <button onClick={()=>setImportExportDrawer(false)} className="btn-dash outline float-left tt">
                Cancel
            </button>
            <button onClick={()=>setImportExportDrawer(false)} className="btn-dash dark float-right tt">
                Apply
            </button>
        </div>
      </Drawer>
