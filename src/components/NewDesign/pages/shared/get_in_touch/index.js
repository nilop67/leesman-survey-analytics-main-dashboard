        ...
        <div className="row clearfix">
            <div className="col-lg-12">
              <div className="form__sc">
                <p>This is dummy text. It is intended to be read but it has no meaning. Used as a simulation of actual copy, using ordinary words with normal letter frequencies, it cannot deceive the eye or brain.</p>
                <div className="form__cnt">
                    {select_items.map((item, i, arr) => (
                      <CustomSelect item={item} i={i} arr={arr}/>
                    ))}

                    <input placeholder="Subject of query…" type="text" className="n_input"></input>

                    <textarea placeholder="Query content…" type="text" className="n_input"></textarea>


                    <button className="btn-dash dark">
                        Submit
                    </button>
                </div>
              </div>
