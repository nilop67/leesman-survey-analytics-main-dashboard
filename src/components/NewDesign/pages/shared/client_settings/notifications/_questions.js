    ...
    <Drawer
      ...
      >
        <div className="n_drawer_body">
            <button onClick={()=>setQuestionsDrawer(false)} className="drawer__close"><span className="cxv-close-l-icn"></span></button>
            ...
            <div className="row">
              ...
              <div className="col-lg-12">
                <div className="n__form_control">
                  <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="Planned meetings" value="Planned meetings"/>
              ...
              <div className="col-lg-12">
                <div className="n__form_control">
                  <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="Learning from others" value="Learning from others"/>
              ...
              <div className="col-lg-12">
                <div className="n__form_control">
                  <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="Individual focused work at a desk" value="Individual focused work at a desk"/>
                    <span className="label-_text">Individual focused work at a desk</span>
                    <span className="checkmark"></span>
                  </label>
                </div>
              </div>
              ...
              <div className="col-lg-12">
                <div className="n__form_control">
                  <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="Thinking/creative thinking" value="Thinking/creative thinking"/>
                    <span className="label-_text">Thinking/creative thinking</span>
                    <span className="checkmark"></span>
                  </label>
                </div>
              </div>
              ...
              <div className="col-lg-12">
                <div className="n__form_control">
                  <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="Relaxing/taking a break" value="Relaxing/taking a break"/>
              ...
              <div className="col-lg-12">
                <div className="n__form_control">
                  <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="Small meeting rooms" value="Small meeting rooms"/>
              ...
              <div className="col-lg-12">
                <div className="n__form_control">
                  <label className="n__form_label dashboard_check">
                    <input type="checkbox" name="General décor" value="General décor"/>
        ...
        <div className="bottom_side">
            <button onClick={()=>setQuestionsDrawer(false)} className="btn-dash outline float-left tt">
                Cancel
            </button>
            <button onClick={()=>setQuestionsDrawer(false)} className="btn-dash dark float-right tt">
                Apply
            </button>
        </div>
      </Drawer>
