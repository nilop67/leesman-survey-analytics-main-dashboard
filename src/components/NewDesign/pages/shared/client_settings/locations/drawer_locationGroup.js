...
const DrawerLocationGroup =({isLocationGroupDrawer, setLocationGroupDrawer, title})=> {

  const [expandedKeys, setExpandedKeys] = useState(['Location 0-0-0', 'Location 0-0-1']);
  ...
  return (
    ...
    <Drawer
        ...
        extra={
          <Space>
            <Button onClick={()=>setLocationGroupDrawer(false)}>Cancel</Button>
            <Button type="primary" onClick={()=>setLocationGroupDrawer(false)}>
              OK
            </Button>
          </Space>
        }
      >
        <div className="n_drawer_body">
            <button onClick={()=>setLocationGroupDrawer(false)} className="drawer__close"><span className="cxv-close-l-icn"></span></button>
        ...
        <div className="bottom_side">
            <button onClick={()=>setLocationGroupDrawer(false)} className="btn-dash outline float-left tt">
                Cancel
            </button>
            <button onClick={()=>setLocationGroupDrawer(false)} className="btn-dash dark float-right tt">
                Apply
            </button>
        </div>
      </Drawer>
