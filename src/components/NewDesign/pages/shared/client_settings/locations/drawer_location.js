    ...
    <Drawer
      ...
      >
        <div className="n_drawer_body">
            <button onClick={()=>setLocationDrawer(false)} className="drawer__close"><span className="cxv-close-l-icn"></span></button>
            ...
            <div className="row">
              <div className="col-lg-12">
                  <div className="n_menu_horizontal top">
                    <a onClick={() => setMenu("Locations")} href="#!" className={`${isMenu === "Locations" ? " active" : ""} `}>
                      Locations
                    </a>
                    <a onClick={() => setMenu("Floors")} href="#!" className={`${isMenu === "Floors" ? " active" : ""} `}>
                      Floors
                    </a>
                  </div>
              </div>
              ...
              <div className="col-lg-6">
                <div className="n__form_control">
                  <label className="n__form_label">
                    <span>Leesman inside target population</span>
                    <input type="number" name="name" className="n__form_input" />
                  </label>
                </div>
              </div>
              ...
              <div className="col-lg-12">
                <div className="n__form_control">
                  <label className="n__form_label">
                    ...
                    <textarea type="text" name="name" className="n__form_input" />
                  </label>
                </div>
              </div>
              </>
              ...
              <div className="col-lg-12">
                <div className="n__form_control input_has_btn">
                  <label className="n__form_label">
                    ...
                    <div className="group">
                      <input type="text" name="name" className="n__form_input" placeholder='Floor label...' />
              ...
              <div className="col-lg-12">
                <div className="n__form_control input_has_btn">
                  <label className="n__form_label">
                    <div className="group">
                      <input type="text" name="name" className="n__form_input" defaultValue='Floor 1...' />
              ...
              <div className="col-lg-12">
                <div className="n__form_control input_has_btn">
                  <label className="n__form_label">
                    <div className="group">
                      <input type="text" name="name" className="n__form_input" defaultValue='Floor 2...' />
                      <button className="iconic__btn" title="Delete"><span className="iconx-minus1"></span></button>
                    </div>
                  </label>
                </div>
        ...
        <div className="bottom_side">
            <button onClick={()=>setLocationDrawer(false)} className="btn-dash outline float-left tt">
                Cancel
            </button>
            <button onClick={()=>setLocationDrawer(false)} className="btn-dash dark float-right tt">
                Apply
            </button>
        </div>
      </Drawer>
