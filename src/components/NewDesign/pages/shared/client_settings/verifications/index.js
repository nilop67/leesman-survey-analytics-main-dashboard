  ...
  return (
    ...
    <div className="n__card hast__table mt-0">
      <div className="n__body">
        ...
        <span className="card_desc">Total: <strong>11 {isMenuSub === "Domains" ? "domains" : "emails"}</strong></span><br/><br/>
        {isMenuSub === "Emails" && 
        <span className="card_desc info">
          <strong><span className="iconx-info-with-circle"></span> Please add the token in a TXT record to your domain under the name _leesman</strong>
