...
const AnalyticsMain = () => {
  ...
  const { allCountries, allWorkplaces, allEmployees, LMIByClientId, HLMIByClientId } = useSelector(store => store.newSurveyHomeReducer);
        ...
        <div className="row clearfix top-info">
          <div className="col-lg-6">
            <div className="main__hero_left">
              ...
              <h1><span>Welcome —</span><br />to Leesman Surveys</h1>
              <p>Our employee workplace experience data is the largest<br /> database of its kind. The data, collected via our Leesman Surveys,<br /> fuel our insights and helps us to understand what makes a great<br /> place to work.</p>
            </div>
          </div>
          <div className="col-lg-6">
          ...
          <div className="col-lg-12">
            <div className="main__divider"><div className="line"></div></div>
          </div>
          <div className="col-lg-12">
            <div className="main__section">
              <div className="info">
                <div className="area">
                  ...
                  <p>This is dummy text. It is intended to be read but it has no meaning. Used as a simulation of actual copy, it cannot deceive the eye or brain.</p>
                </div>
              </div>
              <div className="map">
                <div className="area">
            ...
            <div className="main__section">
              <div className="info">
                <div className="area">
                  ...
                  <p>Click below for a detailed view of your company data based on your survey results.</p>

                  <NavLink className="btn-dash" to="/analytics-overview">View full data</NavLink>
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-12">
            <div className="main__divider ara"><div className="line"></div></div>
          </div>
          <div className="col-lg-12">
            <div className="main__section">
              <div className="info">
                <div className="area">
                  <h2>Resources</h2>
                  <p>As hybrid continues to dominate the global workforce we have developed tools, solutions and collated valuable research to help our clients plan their hybrid future.</p>
                </div>
              </div>
              <div className="blog">
                <div className="area">
                  <div className="blog_cards">
                    <Slider {...slideSettings}>
                      <BlogCard
                        ...
                        desc={"Our experts unpack the insights from the second half of 2021 and discuss the various factors that may influence employees’ intentions regarding their workplace."}
                        date_title={"Date —"}
                        date={"00 Month 2021"}
                      ...
                      <BlogCard
                        ...
                        desc={"Take a look at the employee experience data is currently telling us by viewing the results of each line of enquiry."}
                        date_title={"Data updated —"}
                        date={"30 June 2021"}
                        btn_title={"How Leesman Hybrid works"}
                        btn_url={"https://www.leesmanindex.com/the-hybrid-workstyle/#:~:text=How%20it%20works,into%20one%20of%20five%20personas."}
                        target={"_blank"}
                      />
                      <BlogCard
                        img_url={"/assets/images/temp/r_3.jpg"}
                        main_title={"Hybrid Occupancy Calculator"}
                        desc={"The Leesman Hybrid Occupancy Calculator has been developed to help organisations plan their hybrid workplace future."}
