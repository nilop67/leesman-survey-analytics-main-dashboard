...
const Chart = ({data}) => {
    ...
    <div className="range_bar_chart">
            ...
            {data.map((item) => (
                <div className="item">
                    ...
                    <div className="bar_container">
                        ...
                        <div style={{height:`${item.bar_height}%`, bottom:`${item.bar_bottom}%`}} className={`bar ${item.bar_color} `}></div>
                    </div>
                </div>
            ))}
        </div>
        <div className="data_label_section">
            <ul>
                {data.map((item) => (
                    <li><span className={`marker ${item.legend_color} `}></span> {item.legend_label}</li>
                ))}
            </ul>
        </div>
