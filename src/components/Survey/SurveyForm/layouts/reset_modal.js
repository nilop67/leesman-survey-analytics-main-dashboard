        ...
        <div className="modal-dialog modal-dialog-centered survey-__modal">
          <StyleRoot style={styles.zoomIn} className="text_section intro__body">
            <div className="modal-content">
              ...
              <div className="modal-body">Are you sure you want to delete all your answers?</div>
              <div className="modal-footer d-flex justify-content-between">
                ...
                <button type="button" className="btn-dash dark float-right" data-dismiss="modal" onClick={() => resetAnswer()}>
                  Yes
                </button>
              </div>
            </div>
