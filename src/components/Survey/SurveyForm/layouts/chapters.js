...
import { findTextFromTranslations, modifyDates, replaceJSX } from "../../../../util/functions";
const styles = {
  fadeInLeft: {
    animation: "x 1s",
...
// bg-orange
export const LoginPage = ({ setPage, data, pages, userInfo, setUserInfo, code, setAnswers, selectedLanguageId }) => {
  ...
  const onSubmit = () => {
    if (data?.domains) {
      ...
      if (!validator.isEmail(email)) {
        setErrorMessage(
          findTextFromTranslations("Please enter a valid email address.", selectedLanguageId, data?.customisations)
        );
      } else if (domains?.includes(email.split("@")[1]) || email.split("@")[1].includes("leesmanindex.com")) {
        setErrorMessage("");
        checkUser();
      } else {
        setErrorMessage(
    ...
    <>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        ...
        <div className="form-group type-email">
          <div className="fl-wrap fl-wrap-input fl-is-required">
            <input
              ...
              placeholder={findTextFromTranslations("Email", selectedLanguageId, data?.customisations)}
            />
          </div>
        ...
        <div className="chapter-_btns">
          <button onClick={onSubmit} id="hover-_hand" className={`btn_1 validate ${!data?.domains && "disable_it"}`}>
            {findTextFromTranslations("Enter", selectedLanguageId, data?.customisations)}
          </button>
        </div>
      </StyleRoot>
    </>
      ...
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
          <span className="green-bold">
            {findTextFromTranslations(message, selectedLanguageId, data.customisations)?.split("-")[0]}{" "}
            <span className="line-_thin">―</span>{" "}
          </span>
          {findTextFromTranslations(message, selectedLanguageId, data.customisations)?.split("-")[1]?.split("\n")[0]}
        </h2>
        <p className="intro-_p">
          {findTextFromTranslations(message, selectedLanguageId, data.customisations)?.split("\n")[1]}{" "}
          {data?.customisations?.filter((i) => i.type === "intro" && i.survey_id === data?.general?.id && i.language_id === 12)[0]
            ?.label?.length > 0 && (
            <>
              <a
                ...
                id="hover-_hand"
              >
                {findTextFromTranslations("Read more here", selectedLanguageId, data.customisations)}
        ...
        <div className="chapter-_btns">
          ...
          <button id="hover-_hand" className="btn_1 validate" onClick={() => setPage(3)}>
            {findTextFromTranslations("Enter", selectedLanguageId, data.customisations)}
          </button>
        </div>
      </StyleRoot>
  ...
  return (
    <>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        ...
        <p className="intro-_p">
          The survey should take 10 minutes to complete, and your results will remain entirely confidential and anonymous. The
          more responses we receive, the more accurate your workplace picture will be. Thank you.
          <br />
          <br />
          <a href="https://www.leesmanindex.com/" target="_blank" rel="noopener noreferrer" id="hover-_hand">
        ...
        <div className="chapter-_btns">
          ...
          <a className="find-btn ml-3" href="#!" target="_blank" rel="noopener noreferrer" id="hover-_hand">
    ...
    setLabel(
      <ReactMarkdown>
        {modifyDates(
          ...
          findTextFromTranslations("intro", parseInt(selectedLanguageId), data?.customisations) === "intro"
            ? findTextFromTranslations("intro", parseInt(12), data?.customisations)
            : findTextFromTranslations("intro", parseInt(selectedLanguageId), data?.customisations)
        )}
      </ReactMarkdown>
    );
  ...
  return (
    <>
      <StyleRoot style={styles.fadeInUp} className="text_section intro__body">
        ...
        <br></br>
        <div className="chapter-_btns">
          <button id="hover-_hand" className="btn_2 mr-3 validate" onClick={() => setPage(2)}>
            {findTextFromTranslations("Back", selectedLanguageId, data.customisations)}
          </button>
          <button id="hover-_hand" className="btn_1 validate" onClick={() => setPage(3)}>
            {findTextFromTranslations("Enter", selectedLanguageId, data.customisations)}
          </button>
    ...
    <>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
          <img src="/assets/images/chapter_icons/chapter--1.png" alt="" className="img-fluid" width="200" height="200" />
        </figure>
      </StyleRoot>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
        ...
        <p className="intro-_p">
          We’d like to start by asking you a few questions about you and what’s important to the work that you do, so we can
          understand your work style. Remember, your answers remain anonymous and confidential.
        </p>

        <div className="chapter-_btns">
          <button id="hover-_hand" className="btn_2 mr-3 validate" onClick={() => setPage(6)}>
            Back
          </button>

          <button id="hover-_hand" className="btn_1 validate" onClick={() => setPage(6)}>
            Next
          </button>
        </div>
      </StyleRoot>
...
export const ThanksPage = ({ setPage, isPage, data, selectedLanguageId }) => {
  ...
  useEffect(() => {
    data?.customisations?.filter((i) => i.type === "close" && i.language_id === 12).length && setHasTailoredClose(true);
  }, [data?.customisations]);
  return (
    <div>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
          <img src="/assets/images/temp/img--2.png" alt="" className="img-fluid" width="200" height="200" />
        </figure>
      </StyleRoot>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
            ...
            <StyleRoot style={styles.fadeInUp} className="text_section intro__body">
              <ReactMarkdown>
                {modifyDates(
                  data?.general?.start_date,
                  data?.general?.end_date,
                  data?.customisations?.filter((i) => i.type === "close" && i.language_id === selectedLanguageId)[0]?.label?.length
                    ? data?.customisations?.filter((i) => i.type === "close" && i.language_id === selectedLanguageId)[0]?.label
                    : data?.customisations?.filter((i) => i.type === "close" && i.language_id === 12)[0]?.label
                )}
              </ReactMarkdown>
            </StyleRoot>
          ) : (
...
// bg-white
export const BackToSurveyEnterCode = ({ setPage, data, pages, userInfo, setUserInfo, code, setAnswers, selectedLanguageId }) => {
    ...
    <>
      ...
      <StyleRoot style={styles.fadeInUp} className="text_section">
        ...
        {inputVisible && (
          <>
            <input
              ...
              placeholder={findTextFromTranslations("Reference Number", selectedLanguageId, data.customisations)}
            ></input>
            <span className="input_error">{errorMessage}</span>
          </>
        )}
        ...
        <div className="chapter-_btns">
          ...
          >
            {findTextFromTranslations("Resume survey", selectedLanguageId, data.customisations)}
          </button>

          <button id="hover-_hand" onClick={() => checkUser(null)} disabled={!data.general} className="btn_1 validate">
            {findTextFromTranslations("Start survey", selectedLanguageId, data.customisations)}
          </button>
        </div>
      </StyleRoot>
    </>
...
// bg-orange
export const ClosedSurveyThanksPage = ({ setPage, isPage, data, selectedLanguageId }) => {
  return (
    <div>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
          <img src="/assets/images/temp/img--3.png" alt="" className="img-fluid" width="200" height="200" />
        </figure>
      </StyleRoot>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
...
// bg-orange
export const SurveyNotFoundPage = ({ setPage, isPage, data, selectedLanguageId }) => {
  return (
    <div>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
      ...
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
          <span className="default-bold">
            {
              findTextFromTranslations("Sorry - This link cannot be found.", selectedLanguageId, data?.customisations)?.split(
                " - "
              )[0]
            }{" "}
            <span className="line-_thin">―</span>
...
export const OfficePage = ({ setPage, isPage }) => {
  return (
    <div>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
          <img src="/assets/images/chapter_icons/chapter--2.png" alt="" className="img-fluid" width="200" height="200" />
        </figure>
      </StyleRoot>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
        ...
        <p className="intro-_p">
          This is dummy text. It is intended to be read but it has no meaning. Used as a simulation of actual copy, using ordinary
          words with normal letter frequencies, it cannot deceive the eye or brain.
        </p>
...
export const HomePage = ({ setPage, isPage }) => {
  return (
    <div>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
          <img src="/assets/images/chapter_icons/chapter--3.png" alt="" className="img-fluid" width="200" height="200" />
        </figure>
      </StyleRoot>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
...
export const ClientSpecificPage = ({ setPage, isPage }) => {
  return (
    <div>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
          <img src="/assets/images/chapter_icons/chapter--19.png" alt="" className="img-fluid" width="200" height="200" />
        </figure>
      </StyleRoot>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
...
// bg-white
export const NearlyDonePage = ({ setPage, isPage, userInfo, code, selectedLanguageId, data }) => {
  const finishSurvey = () => {
    axios
  ...
  return (
    <div>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
          <img src="/assets/images/temp/img--7.png" alt="" className="img-fluid" width="200" height="200" />
        </figure>
      </StyleRoot>
      <StyleRoot style={styles.fadeInUp} className="text_section">
        <h2 className="xl">
        ...
        <div className="chapter-_btns">
          <button
            ...
            className="btn_2 mr-3 validate"
          >
            {findTextFromTranslations("Review survey", selectedLanguageId, data.customisations)}
          </button>
          ...
          <button
            ...
            className="btn_1 validate"
          >
            {findTextFromTranslations("Submit survey", selectedLanguageId, data.customisations)}
          </button>
        </div>
      </StyleRoot>
    </div>
...
export const ChapterHasIconComponent = ({
  ...
  return (
    <>
      <StyleRoot style={styles.fadeInRight}>
        <figure className="hero_item">
          <img src={imgUrl} alt={imgTitle} className="img-fluid" width="200" height="200" />
        </figure>
      </StyleRoot>
      <StyleRoot style={styles.fadeInUp} className="text_section">
