...
const Modal = ({ isLater, saveLater, loginType, setPage, selectedLanguageId, initData, userInfo }) => {
  ...
  useEffect(() => {
    switch (loginType) {
      case "email":
        setLabel("Thanks, your survey has been saved. To resume the survey, enter the same email address you used.");
        break;
      case "referance":
        setLabel("To resume your survey later, please make a note of your unique reference number:");
        setCode("R3suM3789");
        break;
      default:
        break;
