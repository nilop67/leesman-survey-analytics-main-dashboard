...
import { percentage_items, percentage_items_total, binary_items, binary_items_static, drodown_items } from "./0_dummy_data";
    ...
    <StyleRoot style={isMobileDevice ? null : styles.fadeInRight}>
      <div id="middle-wizard">
        <div className="question_div" id="scroll__that">
          ...
          <h3 className="main_question">
            DropdownSelect Q ― Please answer the following questions about yourself and your role within your organisation.
          </h3>
      ...
      <div id="middle-wizard">
        <div className="question_div" id="scroll__that">
          ...
          <br />
          <h3 className="main_question">
            SliderPercentageTotal Q ― On average, what proportion of your work time at{" "}
            <span className="text-blue">Organisation name</span> do you spend at the following locations? Drag the sliders to
            total 100%, and tick the ‘I have no fixed routine box / As required’ box if applicable.
            <br />
            <br />
            Please note: the information you provide here helps us understand which sections of the survey are relevant to you.
          </h3>
          {percentage_items_total.map((item, i, arr) => (
            <SliderPercentageTotal item={item} i={i} arr={arr} setTotalValues={setTotalValues} valuesTotal={valuesTotal} />
          ))}
      ...
      <div id="middle-wizard">
        <div className="question_div" id="scroll__that">
          {/* Question Title */}
          <h3 className="main_question">
            SliderPercentage Q ― Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
      ...
      <div className="question_div" id="scroll__that">
        ...
        <br />
        <h3 className="main_question">
          SliderBinaryStatic Q ― Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
          labore et dolore magna aliqua?
        </h3>
        <div id="middle-wizard">
      ...
      <div className="question_div" id="scroll__that">
        ...
        <br />
        <h3 className="main_question">
          SliderBinary Q ― Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
          dolore magna aliqua?
          <br />
          <br />
          Greatest impact being 1 and lowest impact being 5, only one ranking number can be used per "aspect".
        </h3>
        <div id="middle-wizard">
