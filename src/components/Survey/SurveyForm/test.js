...
const SurveyForm = ({ isStart, setStart, isLoader, setLoader, isInfo, setInfo, isSubmitted, setSubmitted, isPage, setPage }) => {
        ...
        <div className="row row-height">
          ...
          >
            <div id="survey-_scroll" className="survey_-wrapper">
              ...
              <div
                className={`left_info-survey  has_figure ${isPage <= 5 || isPage === 21 ? " " : " "} 
