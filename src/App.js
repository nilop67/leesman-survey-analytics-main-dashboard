...
const App = ({
  ...
  //for disable all the console messages
  ...
  useEffect(() => {
    ...
    ${window.location.pathname === "/survey-setup" ? " survey__first survey-_body " : ""}`;
  }, [themeColor, fontStyle, lightVersion, RtlVersion, loginBackground, offcanvas, miniSidebar, horizontalMenu, miniHover]);
      ...
      <AuthProvider>
        <Router history={history} basename="dashboards">
          ...
          <Switch>
            ...
            {/* Analytics Supporting Documents */}
            <Route path="/supporting-docs" component={AnalyticsSupportingDocs} />
